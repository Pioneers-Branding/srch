            ...
            <x-slot name="toolbar">
              ...
              <div class="input-group flex-nowrap">
                ...
                @hasPermission('add_category')
                  <button type="button" class="btn btn-primary" data-crud-id="{{0}}"><i class="fas fa-plus-circle"></i>{{ __('messages.create') }} Category </button>
                @endhasPermission
            </x-slot>
          </x-backend.section-header>
...
@push('after-scripts')
    <script src="{{ asset('modules/category/script.js') }}"></script>
    ...
    const columns = [
            ...
            { data: 'banner_image', name: 'banner_image', title: "{{ __('Banner Image') }}", width: '10%', orderable: false,},
