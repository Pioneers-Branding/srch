    ...
    public function index_data(Datatables $datatable, Request $request)
    {
        ...
        $datatable = $datatable->eloquent($query)
            ...
            ->addColumn('banner_image', function ($data) {
                return '<img src='.$data->banner." class='avatar avatar-50 rounded-pill'>";
            })
        ...
        return $datatable->rawColumns(array_merge(['action', 'status', 'image', 'check', 'name' , 'banner_image'], $customFieldColumns))
            ->toJson();
    }
