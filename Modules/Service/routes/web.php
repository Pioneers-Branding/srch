...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['web', 'auth']], function () {
    ...
    */
    ...
    Route::group(['prefix' => 'services', 'as' => 'services.'], function () {
        ...
        // Service Steps
        Route::get('/steps/{id}', [ServicesController::class, 'getSteps']);
        Route::post('/steps/{id}', [ServicesController::class, 'uploadSteps']);
        ...
        Route::get('/get-child-category', [ServicesController::class, 'getChildCategory'])->name('get_child_category');
        Route::get('/get-child-category-by-sub_id', [ServicesController::class, 'getChildCategoryList'])->name('get_child_category_list');
        Route::get('/get-category-id', [ServicesController::class, 'getSubCategoryId'])->name('get_category_id');
