...
export const CHILD_CATEGORY_LIST = ({type = 'select',id = null}) => {return {path: `services/get-child-category-by-sub_id?type=${type}&sub_id=${id}`, method: 'GET'}} 
...
// STEP Assign
export const GET_STEP_URL = (id) => {return {path: `${MODULE}/steps/${id}`, method: 'GET'}}
export const POST_STEP_URL = (id) => {return {path: `${MODULE}/steps/${id}`, method: 'POST'}}
