...
@push('after-styles')
    <link rel="stylesheet" href="{{ asset('modules/blog/style.css') }}">
@endpush
  ...
  {{--          </button>--}}
            ...
            <x-slot name="toolbar">
              ...
              <div class="input-group flex-nowrap">
                ...
                @hasPermission('add_blog')
                  <button type="button" class="btn btn-primary" data-crud-id="{{0}}"><i class="fas fa-plus-circle"></i>{{ __('messages.create') }} Blog </button>
                @endhasPermission
            </x-slot>
          </x-backend.section-header>
    ...
    <div data-render="app">
      <form-offcanvas
              ...
              create-title="{{ __('messages.create') }} {{ __('New') }} Blog " edit-title="{{ __('messages.edit') }} Blog "
...
@push('after-scripts')
    <script src="{{ asset('modules/blog/script.js') }}"></script>
