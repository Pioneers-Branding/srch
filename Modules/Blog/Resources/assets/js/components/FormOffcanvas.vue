        ...
        <div class="row">
          <div class="col-12">
            <div class="form-group">
              ...
              <label class="form-label" for="blog_image">{{$t('Image')}}</label>
              <input type="file" class="form-control" id="blog_image" @change="fileUpload" accept=".jpeg, .jpg, .png, .gif" />
            ...
            <div class="form-group" >
              ...
              <Multiselect v-bind="singleSelectOption" v-model="category_id" :value="category_id" :options="categories"></Multiselect>
            </div>
            <InputField :is-required="true" :label="$t('Name')" placeholder="" v-model="name" :error-message="errors.name" :error-messages="errorMessages['name']"></InputField>
...
import { INDEX_LIST_URL, EDIT_URL, STORE_URL, UPDATE_URL } from '../constant/blog'
...
const updatecurrentId = (e) => {
  ...
  category_id.value = e.detail.category_id || null
