...
class BookingVendorCancle extends Model implements HasMedia
{
    use HasFactory;
    use InteractsWithMedia;

    protected $table = 'cancle_vendor_booking';

    const CUSTOM_FIELD_MODEL = 'Modules\Booking\Models\BookingVendorCancle';

    protected $fillable = ['booking_id', 'vendor_id'];
