...
class BookingTransaction extends Model
{
    ...
    protected $fillable = ['booking_id', 'external_transaction_id', 'transaction_type', 'discount_percentage', 'discount_amount', 'tip_amount', 'tax_percentage', 'payment_status' , 'razorpay_payment_id' , 'razorpay_order_id'];
