...
class Booking extends BaseModel
{
    ...
    public function vendorcancle()
    {
        return $this->belongsTo(BookingVendorCancle::class, 'booking_id');
    }
    ...
    public function commissionBooking()
    {
        return $this->hasOne(CommissionEarning::class);
    }
    
    public function bookingCheckoutProduct()
    {
        return $this->hasMany(BookingVendorProduct::class, 'booking_id', 'id');
    }
    
    public function bookingCheckoutProductImages()
    {
        return $this->hasMany(BookingVendorProduct::class, 'booking_id_img', 'id');
    }
}
