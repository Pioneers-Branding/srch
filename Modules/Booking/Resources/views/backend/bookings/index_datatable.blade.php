...
<a href="{{route("backend.$module_name.index")}}" class="btn btn-soft-dark d-none"><i
...
$(document).on("change", "#vendor_payment_status", function(e) {
    e.preventDefault();

    var id = $(this).attr('data-id');
    var vendor_payment_status = $(this).val();
    var modalId = $(this).attr('data-modal-id');

    if ($(this).val() !== '') {
        $.ajax({
            url: "{{ route('backend.bookings.vendor_payment_status') }}", 
            method: 'POST',
            data: {
                id: id,
