...
class EmployeesController extends Controller
{
    ...
    public function index_data(Datatables $datatable, Request $request)
    {
        ...
        $datatable = $datatable->eloquent($query)
            ...
            ->editColumn('is_manager', function ($data) {
                if ($data->is_manager) {
                    return '<span class="badge bg-soft-danger">Vendor</span>';
                }
    ...
    public function store(EmployeeRequest $request)
    {
        ...
        if ($request->has('all_service')) {

            if ($request->all_service !== null) {
        ...
        $message = __('messages.create_form', ['form' => __('Vendor')]);
    ...
    public function edit($id)
    {
        ...
        $give_servicesIds = count($data->services->pluck('service_id') ?? []);
        
        $serviceIds = count(Service::where('status' , 1 )->get()->pluck('id'));

        $data['all_service'] = ($give_servicesIds == $serviceIds) ? 1: 0;
    ...
    public function update(EmployeeRequest $request, $id)
    {
        ...
        $message = __('messages.update_form', ['form' => __('Vendor')]);
    ...
    public function destroy($id)
    {
        ...
        $message = __('messages.delete_form', ['form' => __('Vendor')]);
