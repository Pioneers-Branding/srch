        ...
        <div class="row">
          <div class="col-12 row">
            ...
            <div class="row" v-if="currentId === 0">
              <InputField type="password" class="col-md-6"  :label="$t('employee.lbl_password')"
              ...
              <InputField type="password" class="col-md-6"  :label="$t('employee.lbl_confirm_password')"
            ...
            <div class="form-group m-0 col-md-4 mb-2">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" :true-value="1" :false-value="0" v-model="all_service"
                  id="all-service" :checked="all_service">
                <label class="form-check-label" for="all-service">
                  All Service
                </label>
              </div>
            </div>
...
const { value: all_service } = useField('all_service')  
...
const handleInput = (phone, phoneObject) => {
  ...
  // console.log(phone); 
  // console.log(phoneObject.nationalNumber);
  if (phoneObject?.formatted) {
    mobile.value = phoneObject.nationalNumber
  }
};
