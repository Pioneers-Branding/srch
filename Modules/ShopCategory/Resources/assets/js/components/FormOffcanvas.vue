      ...
      <div class="offcanvas-body">
        <div class="row">
          <div class="col-12">
            ...
            <InputField :is-required="true" :label="$t('Gallery Name')" placeholder="" v-model="name" :error-message="errors.name" :error-messages="errorMessages['name']"></InputField>
...
import {EDIT_URL, STORE_URL, UPDATE_URL } from '../constant/category'
