...
@push('after-styles')
    <link rel="stylesheet" href="{{ asset('modules/shopcategory/style.css') }}">
@endpush
  ...
  {{--          </button>--}}
            ...
            <x-slot name="toolbar">
              ...
              <div class="input-group flex-nowrap">
                ...
                @hasPermission('add_shopcategory')
                  <button type="button" class="btn btn-primary" data-crud-id="{{0}}"><i class="fas fa-plus-circle"></i>{{ __('messages.create') }} gallery </button>
                @endhasPermission
            </x-slot>
          </x-backend.section-header>
    ...
    <div data-render="app">
      <form-offcanvas
              ...
              create-title="{{ __('messages.create') }} {{ __('New') }} Category " edit-title="{{ __('messages.edit') }} Category "
...
@push('after-scripts')
    <script src="{{ asset('modules/shopcategory/script.js') }}"></script>
