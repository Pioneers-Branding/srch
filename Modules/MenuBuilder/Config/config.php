...
return [
    ...
    'ARRAY_MENU' => [
        ...
        [
            ...
            'children' => [
                ...
                [
                    'title' => 'sidebar.child_categories',
                    'route' => 'backend.childcategories.index',
                    'active' => ['app/child-categories'],
                    'permission' => ['view_childcategory'],
                    'order' => 3,
                    'menu_level' => 1,
                ],
            ],
        ...
        [
            ...
            'title' => 'sidebar.vendors.earnings',
        ...
        [
            ...
            'title' => 'sidebar.vendors.services',
        ...
        [
            'start_icon' => 'fa fa-sliders',
            'title' => 'sidebar.app_coupons',
            'route' => 'backend.app-coupons.index',
            'active' => 'app/app-coupons',
            'permission' => ['view_app_coupons'],
            'order' => 26,
        ]
        // [
    ...
    'menu_routes' => [
        ...
        [
            'route' => 'backend.shopcategories.index',
            'title' => 'Shop Categories',
        ],
        [
            'route' => 'backend.shopproduct.index',
            'title' => 'Shop Products',
        ], 
        [ 
            'route' => 'backend.orders.datatable_view',
            'title' => 'Orders',
        ],
        [ 
