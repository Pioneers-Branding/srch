...
@endsection
@push('after-styles')
<link rel="stylesheet" href="{{ asset('modules/coupon/style.css') }}">
@endpush
...
<div class="card">
    <div class="card-body">
        ...
        <div data-render="app">
            <coupon-form-offcanvas create-title="{{ __('messages.create') }} {{ __('messages.new') }} {{ __($module_title) }}"
                edit-title="{{ __('messages.edit') }} {{ __($module_title) }}"></coupon-form-offcanvas>
        </div>
    </div>

    <div data-render="app">
        <coupon-form-offcanvas create-title="{{ __('messages.create') }} {{ __($module_title) }}" edit-title="{{ __('messages.edit') }} {{ __($module_title) }}"></coupon-form-offcanvas>
    </div>
</div>
@endsection
...
@push('after-scripts')
<!-- DataTables Core and Extensions -->
<script src="{{ asset('modules/coupon/script.js') }}"></script>
