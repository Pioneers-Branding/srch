...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['web', 'auth']], function () {
    ...
    */
    ...
    Route::group(['prefix' => 'app-coupons', 'as' => 'app_coupons.'], function () {
        ...
        Route::patch('trashed/{id}', [CouponsController::class, 'restore'])->name('restore');
    ...
    Route::resource('app-coupons', CouponsController::class);
});
