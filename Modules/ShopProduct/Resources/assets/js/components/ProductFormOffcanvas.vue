  ...
  <form @submit="formSubmit">
    <div class="offcanvas offcanvas-end" tabindex="-1" id="form-offcanvas" aria-labelledby="form-offcanvasLabel">
      ...
      <div class="offcanvas-body">
        ...
        <InputField class="col-md-12" type="text" :is-required="true" :label="$t('Quantity')"  placeholder="" v-model="quantity" :error-message="errors['quantity']" :error-messages="errorMessages['quantity']"></InputField>
        ...
        <div class="form-group">
          ...
          <Multiselect v-model="category_id" :value="category_id" v-bind="categories" id="category_id" ></Multiselect>
...
import { EDIT_URL, STORE_URL, UPDATE_URL, CATEGORY_LIST  } from '../constant/product'
...
const validationSchema = yup.object({
  ...
  quantity: yup.string().required('Quantity is a required field').matches(/^\d+$/, 'Only numbers are allowed'),
