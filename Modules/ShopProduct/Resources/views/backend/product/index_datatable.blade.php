...
@push('after-styles')
    <link rel="stylesheet" href="{{ asset('modules/shopproduct/style.css') }}">
@endpush
...
@push('after-scripts')
    ...
    <script src="{{ asset('modules/shopproduct/script.js') }}"></script>
