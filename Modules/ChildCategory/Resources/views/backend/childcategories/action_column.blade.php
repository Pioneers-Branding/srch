<div class="d-flex gap-2 align-items-center">
  @hasPermission('edit_childcategory')
      <button type="button" class="btn btn-soft-primary btn-sm" data-crud-id="{{$data->id}}" data-sub-id="{{$data->sub_id}}" data-bs-toggle="tooltip" title="{{ __('messages.edit') }}"> <i class="fa-solid fa-pen-clip"></i></button>
  @endhasPermission
  @hasPermission('delete_childcategory')
