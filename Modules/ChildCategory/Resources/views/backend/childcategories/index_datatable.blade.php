...
@push('after-styles')
    <link rel="stylesheet" href="{{ asset('modules/childcategory/style.css') }}">
@endpush
  ...
  {{--          </button>--}}
            ...
            <x-slot name="toolbar">
              ...
              <div class="input-group flex-nowrap">
                ...
                @hasPermission('add_childcategory')
                  <button type="button" class="btn btn-primary" data-crud-id="{{0}}"><i class="fas fa-plus-circle"></i>{{ __('messages.create') }} Child Category</button>
                @endhasPermission
            </x-slot>
          </x-backend.section-header>
    ...
    <div data-render="app">
      <form-offcanvas
              ...
              create-title="{{ __('messages.create') }} {{ __('new') }} Child Category" edit-title="{{ __('messages.edit') }} Child Category"
...
@push('after-scripts')
    <script src="{{ asset('modules/childcategory/script.js') }}"></script>
    ...
    const columns = [
            ...
            { data: 'sub_id', name: 'sub_id', title: "{{ __('Sub Category') }}", width: '15%'},
