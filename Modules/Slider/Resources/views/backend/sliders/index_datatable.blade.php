...
@push('after-styles')
    <link rel="stylesheet" href="{{ asset('modules/constant/style.css') }}">
@endpush
...
<script src="{{ asset('modules/slider/script.js') }}"></script>
...
<script type="text/javascript">
        ...
        // { data: 'banner_type', name: 'banner_type', title: "{{ __('Banner For') }}",  width:'15%'},
        { data: 'image', name: 'image', title: "{{ __('Banner Image') }}",  width:'15%'},
