    ...
    public function handle()
    {
        \Menu::make('menu', function ($menu) {
            ...
            foreach ($menuArray as $key => $value) {
                ...
                if($value->title=='Gallery' || $value->title=='sidebar.calendar_bookings' || $value->title=='sidebar.dashboard' || $value->title=='vendors'   || $value->title=='sidebar.system' || $value->title=='sidebar.reports' || $value->title=='sidebar.finance' ||  $value->title=='sidebar.daily_bookings' ||  $value->title=='vendor earnings' || $value->title=='sidebar.overall_bookings' || $value->title=='vendor services' ||  $value->title=='vendor payouts' || $value->title=='sidebar.notifications' || $value->title=='sidebar.branches' || $value->title=='sidebar.settings' || $value->title=='sidebar.access_control' ||  $value->title=='sidebar.tax' || $value->title=='sidebar.reviews' || $value->title=='sidebar.categories' || $value->title=='sidebar.sub_categories' || $value->title=='childcategory'){ continue; }
          ...
          if (count($value->children) > 0) {
            ...
            if(isset($value->parent)) {
              ...
              foreach ($value->children as $key => $childValue) {
                  ...
                  if($childValue->title=='childcategory') {continue;}
                  $childArr = [
