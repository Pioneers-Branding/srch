<?php include 'header.php';
   if(isset($_GET['sort'])){
         ...
         if($sort==1){
            $pro = towquery("SELECT * FROM `tbl_product`  order by product_price DESC ");
         }else if($sort==2){
            $pro = towquery("SELECT * FROM `tbl_product` order by product_price ASC ");
         }else{
            $pro = towquery("SELECT * FROM `tbl_product`  order by product_pk_id DESC ");
         }
    }else{
    $pro = towquery("SELECT * FROM `tbl_product` ");
    } 
?>
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12" style="margin-top: -10px; margin-bottom:-10px;">
             <h3 style="font-weight: bold; color: #FB9A2E; font-size: 26px; text-align: center;">All Product's</h3>
        </div>
        <div class="col-md-9" style="margin-top: 0px; margin-bottom: 20px;">
        ...
        <div class="col-md-12 col-xs-12" style="padding: 0;">
            <?php while($prof = towfetch($pro)){
                ...
                <div class="col-md-6 col-xs-6" style="padding: 7px;">
                 <div class="col-md-12" style="background: #fff; border: #ccc solid 1px; border-radius:  20px; height: 300px; ">
                        ...
                        <p style="margin-top: 10px; font-size: 18px; font-weight: bold; line-height: 15px; text-align: left;"><a href="product-detail.php?pid=<?=$prof['product_pk_id']?>" style="color: #000; font-size: 12px; line-height: 18px; text-decoration: none;"><b><?=$prof['product_title']?></b></a></p>
