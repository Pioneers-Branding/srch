...
.header-topbar{background: #049FE2 !important;}
...
<!-- Mirrored from www.greateasternretail.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Sep 2023 10:56:32 GMT -->
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16"
        href="<?=$asset_url?>d2afzgorr4mxtq.cloudfront.net/assets/favicon/favicon-16x16.png">
    ...
    <meta property="og:image" content="static/assets/img/great-eastern.png">

    <!-- Twitter Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta property="twitter:domain" content="greateasternretail.com">
    <meta property="twitter:url" content="index.html">
    <meta name="twitter:title" content="Great Eastern Retail | Online Electronics Store In India">
    ...
    <meta name="twitter:image" content="static/assets/img/great-eastern.png">
                ...
                <div class="topbar-right ml-auto py-2 ">
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item mr-0">
                            <a href="javascript:void(0);" class="header-topbar__nav-link"><i style="padding-right: 7px;" class="bi bi-download mr-1"></i>Download App</a>
                        </li>
                        <li class="list-inline-item mr-0">
                ...
                <div id="categories" class="submenu">
                    ...
                    <ul>
                        ...
                        foreach($category_result as $row){
                                    ...
                                    ?>
                        <li class="has-submenu">
                            <a href="#" data-submenu="submenu-1"><?=$row['category']?></a>
                            
                            <div id="submenu-1" class="submenu">
                                <div class="submenu-header">
                                    <a href="#" data-submenu-close="submenu-1">All Categories</a>
                                </div>
                            
                                <?php foreach($subcategory_result as $subcat){
                                                     ?>
                                    <label onclick="location.href='<?=$asset_url?>product.php?sub_cat_id=<?=$subcat['id']?>'"><?= $subcat['category']?></label>
                            ...
                            <div class='row'>
                                <div class='col-lg-12'>
                                    <div class='row'>
                                        ...
                                        <div class='col-lg-3'>
                                            <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSm9v7G3n1bvU0qWYvuetfJY1XJM0bbzo7CAn8BignF&s'>
                                        </div>
                                    </div>
                                </div>
                            </div>
