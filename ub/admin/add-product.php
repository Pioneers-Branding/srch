                           ...
                           <div class="card-body ">
                              ...
                              <div class="row col-md-12">
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="stockQuantity" class="form-control"  id="stockQuantity" >
                                 </div>
                                 <div class="form-group col-md-6">
                              ...
                              <div class="row col-md-12">
                                 <div class="form-group col-md-12">
                                    ...
                                    <textarea name="product_short_desc" class="form-control" id="product_short_desc" ></textarea>
                                 </div>
                              </div>
                              <div class="row col-md-12">
                                 <div class="form-group col-md-12">
