         ...
         <div class="content-wrapper">
            <div class="content-header row">
               <div class="content-header-left col-md-6 col-12 mb-2">
                  <h3 class="content-header-title mb-0">Add Size</h3>
               ...
               <section id="basic-form-layouts">
                  <div class="row">
                     <div class="col-md-12">
                                 ...
                                 <form class="form form-horizontal form-bordered" id="sizeForm" enctype="multipart/form-data">
                                    <div class="form-body">
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-md-9">
                                             <input type="text" id="post_title" class="form-control" placeholder="Enter size Name " name="post_title" required>
                                          </div>
                                       </div>
                                       <div class="form-group row">
                                          <label class="col-md-3 label-control" for="projectinput2">Size Name(French) </label>
                                          <div class="col-md-9">
                                             <input type="text" id="post_title_fr" class="form-control" placeholder="Enter size Name " name="post_title_fr" required>
                                          </div>
                                       </div>
                                       <!--<div class="form-group row">-->
                      ...
                      <input type="hidden" name="size_ref" class="form-control" id="size_ref" >
                                       </div>
...
<!-- END: Content-->
 <script type="text/javascript">
         ...
         $.LoadingOverlay("hide");
         Swal.fire('','Size  Added Successfully','success')
         $("#sizeForm")[0].reset();
         return false;
         }
         if($.trim(data)=='failed'){
