         ...
         <div class="content-wrapper">
            <div class="content-header row">
               <div class="content-header-left col-md-6 col-12 mb-2">
                  <h3 class="content-header-title mb-0">Add Product Type</h3>
                     ...
                     <div class="col-md-12">
                        <div class="card">
                           <div class="card-content collpase show">
                              <div class="card-body">
                                 <form class="form form-horizontal form-bordered" id="productType" enctype="multipart/form-data">
                                    <div class="form-body">
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-md-9">
                                             <input type="text" id="post_title" class="form-control" placeholder="Enter product type Name " name="post_title" required>
                                          </div>
                                       </div>
                                       <div class="form-group row">
                                          <label class="col-md-3 label-control" for="projectinput2">Type Name(French) </label>
                                          <div class="col-md-9">
                                             <input type="text" id="post_title_fr" class="form-control" placeholder="Enter product type Name " name="post_title_fr" required>
                                          </div>
                                       </div>
                                       <!--<div class="form-group row">-->
                      ...
                      <input type="hidden" name="type_ref" class="form-control" id="type_ref" >
                                       </div>
...
<script type="text/javascript">
         ...
         $("#productType").on('submit',(function(e){
         ...
         $.LoadingOverlay("hide");
         Swal.fire('','Product Type Added Successfully','success')
         $("#productType")[0].reset();
         return false;
         }
         if($.trim(data)=='failed'){
         $.LoadingOverlay("hide");
         toastr.error('Failed to Product Type','error')
         $("#productType")[0].reset();
         return false;
         }
         }
