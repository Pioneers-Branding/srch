         ...
         <div class="content-wrapper">
            <div class="content-header row">
               <div class="content-header-left col-md-6 col-12 mb-2">
                  <h3 class="content-header-title mb-0">Add Brand</h3>
                     ...
                     <div class="col-md-12">
                        <div class="card">
                           <div class="card-content collpase show">
                              <div class="card-body">
                                 <form class="form form-horizontal form-bordered" id="brandForm" enctype="multipart/form-data">
                                    <div class="form-body">
                                       <h4 class="form-section">Brand  Info</h4>
                                       <div class="form-group row">
                                          <label class="col-md-3 label-control" for="projectinput2">Brand Name(English) </label>
                                          <div class="col-md-9">
                                             <input type="text" id="post_title" class="form-control" placeholder="Enter Brand Name " name="post_title" required>
                                          </div>
                                       </div>
                                        <div class="form-group row">
                                          <label class="col-md-3 label-control" for="projectinput2">Brand Name(Franch) </label>
                                          <div class="col-md-9">
                                             <input type="text" id="post_title_fr" class="form-control" placeholder="Enter Brand Name " name="post_title_fr" required>
                                          </div>
                                       </div>
                                       <div class="form-group row">
                                          <label class="col-md-3 label-control" for="projectinput2">Image</label>
                                          <div class="col-md-9">
                                             <input type="file" id="post_image" class="form-control"  name="post_image">
                                          </div>
                                       </div>
                                       <div class="form-group row">
...
<div class="form-group row">
  ...
  <div class="col-md-9">
	  <input type="text"  class="form-control" name="meta_keywords_fr" placeholder="enter meta Keywords" />
                      ...
                      <input type="hidden" name="brand_ref" class="form-control" id="brand_ref" >
                                       </div>
...
<!-- END: Content-->
 <script type="text/javascript">
         ...
         if($.trim(data)=='failed'){
         $.LoadingOverlay("hide");
         toastr.error('Failed to add Brand','error')
         $("#brandForm")[0].reset();
         return false;
         }
         }
