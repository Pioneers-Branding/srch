...
$start_from = ($page-1) * $limit;
    ...
    $cat = towquery("SELECT * FROM `tbl_category`  ORDER BY product_pk_id DESC LIMIT $start_from, $limit");
    $cat = towfetch($cat);
    // print_r($cat);
    // exit;
    $bannerImage="";
...
$maxPrice =  getPriceRaneforProduct($cid,"DESC");
     ...
     $query="";
        ...
        $query = "SELECT * FROM `tbl_product` ORDER BY product_pk_id DESC LIMIT $start_from, $limit";
        if(!empty($_GET['pt'])){
    ...
    //  echo $query;
     ...
     $pro = towquery("SELECT * FROM `tbl_product` ORDER BY product_pk_id DESC LIMIT $start_from, $limit" );
    }
    $procount = towquery("SELECT * FROM `tbl_product` ORDER BY product_pk_id" );
