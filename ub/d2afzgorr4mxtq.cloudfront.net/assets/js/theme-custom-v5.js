...
!function(t) {
    ...
    t.ui = t.ui || {},
    t.ui.version = "1.12.1";
    var e, s, n = 0, o = Array.prototype.slice;
    /*!
 ...
 */
    t.cleanData = (s = t.cleanData,
    function(e) {
        var n, o, a;
        for (a = 0; null != (o = e[a]); a++)
            try {
    ...
    t.widget = function(e, s, n) {
        var o, a, r, l = {}, h = e.split(".")[0], c = h + "-" + (e = e.split(".")[1]);
        return n || (n = s,
        s = t.Widget),
        ...
        delete o._childConstructors) : s._childConstructors.push(a),
        t.widget.bridge(e, a),
        a
    }
    ,
    t.widget.extend = function(e) {
        for (var s, n, a = o.call(arguments, 1), r = 0, l = a.length; r < l; r++)
            for (s in a[r])
                n = a[r][s],
                a[r].hasOwnProperty(s) && void 0 !== n && (t.isPlainObject(n) ? e[s] = t.isPlainObject(e[s]) ? t.widget.extend({}, e[s], n) : t.widget.extend({}, n) : e[s] = n);
        return e
    }
    ,
    t.widget.bridge = function(e, s) {
        ...
        t.fn[e] = function(a) {
            ...
            return r ? this.length || "instance" !== a ? this.each(function() {
                ...
                return "instance" === a ? (h = o,
                !1) : o ? t.isFunction(o[a]) && "_" !== a.charAt(0) ? (s = o[a].apply(o, l)) !== o && void 0 !== s ? (h = s && s.jquery ? h.pushStack(s.get()) : s,
            ...
            }) : h = void 0 : (l.length && (a = t.widget.extend.apply(null, [a].concat(l))),
            this.each(function() {
                var e = t.data(this, n);
                e ? (e.option(a || {}),
                e._init && e._init()) : t.data(this, n, new s(a,this))
            })),
            h
        }
    }
    ...
    t.Widget.prototype = {
        ...
        _setOptionClasses: function(e) {
            ...
            for (s in e)
                ...
                e[s] !== this.options.classes[s] && o && o.length && (n = t(o.get()),
        ...
        _classes: function(e) {
            ...
            function o(o, a) {
                ...
                for (l = 0; l < o.length; l++)
                    ...
                    s.push(o[l]),
                    a && e.classes[o[l]] && s.push(e.classes[o[l]])
            }
            return e = t.extend({
        ...
        _toggleClass: function(t, e, s, n) {
            ...
            return a.element.toggleClass(this._classes(a), n),
            this
        },
        _on: function(e, s, n) {
            var o, a = this;
            "boolean" != typeof e && (n = s,
            s = e,
            e = !1),
            n ? (s = o = t(s),
        ...
        _trigger: function(e, s, n) {
            ...
            if (n = n || {},
            (s = t.Event(s)).type = (e === this.widgetEventPrefix ? e : this.widgetEventPrefix + e).toLowerCase(),
            s.target = this.element[0],
            a = s.originalEvent)
                for (o in a)
                    o in s || (s[o] = a[o]);
            return this.element.trigger(s, n),
            !(t.isFunction(r) && !1 === r.apply(this.element[0], [s].concat(n)) || s.isDefaultPrevented())
        }
    },
    t.each({
        show: "fadeIn",
        ...
        t.Widget.prototype["_" + e] = function(n, o, a) {
            ...
            r && t.effects && t.effects.effect[l] ? n[e](o) : l !== e && n[l] ? n[l](o.duration, o.easing, a) : n.queue(function(s) {
                t(this)[e](),
                a && a.call(n[0]),
                s()
            })
    ...
    t.widget,
    function() {
        var e, s = Math.max, n = Math.abs, o = /left|center|right/, a = /top|center|bottom/, r = /[\+\-]\d+(\.[\d]+)?%?/, l = /^\w+/, h = /%$/, c = t.fn.position;
        function u(t, e, s) {
        ...
        t.position = {
            scrollbarWidth: function() {
                if (void 0 !== e)
                    return e;
                var s, n, o = t("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"), a = o.children()[0];
                return t("body").append(o),
                s = a.offsetWidth,
                o.css("overflow", "scroll"),
                s === (n = a.offsetWidth) && (n = o[0].clientWidth),
                o.remove(),
                e = s - n
            },
        ...
        t.fn.position = function(e) {
            ...
            e = t.extend({}, e);
            var h, p, f, g, m, v, b, y, _ = t(e.of), w = t.position.getWithinInfo(e.within), k = t.position.getScrollInfo(w), C = (e.collision || "flip").split(" "), D = {};
            ...
            t.each(["my", "at"], function() {
                ...
                1 === n.length && (n = o.test(n[0]) ? n.concat(["center"]) : a.test(n[0]) ? ["center"].concat(n) : ["center", "center"]),
                n[0] = o.test(n[0]) ? n[0] : "center",
                n[1] = a.test(n[1]) ? n[1] : "center",
                t = r.exec(n[0]),
                s = r.exec(n[1]),
                D[this] = [t ? t[0] : 0, s ? s[0] : 0],
            ...
            m.top += h[1],
            this.each(function() {
                var o, a, r = t(this), l = r.outerWidth(), c = r.outerHeight(), v = d(this, "marginLeft"), b = d(this, "marginTop"), y = l + v + d(this, "marginRight") + k.width, T = c + b + d(this, "marginBottom") + k.height, S = t.extend({}, m), P = u(D.my, r.outerWidth(), r.outerHeight());
                "right" === e.my[0] ? S.left -= l : "center" === e.my[0] && (S.left -= l / 2),
                ...
                e.using && (a = function(t) {
                    ...
                    p < l && n(o + a) < p && (d.horizontal = "center"),
                    f < c && n(h + u) < f && (d.vertical = "middle"),
                    s(n(o), n(a)) > s(n(h), n(u)) ? d.important = "horizontal" : d.important = "vertical",
        ...
        t.ui.position = {
            fit: {
                left: function(t, e) {
                    var n, o = e.within, a = o.isWindow ? o.scrollLeft : o.offset.left, r = o.width, l = t.left - e.collisionPosition.marginLeft, h = a - l, c = l + e.collisionWidth - r - a;
                    e.collisionWidth > r ? h > 0 && c <= 0 ? (n = t.left + h + e.collisionWidth - r - a,
                    t.left += h - n) : t.left = c > 0 && h <= 0 ? a : h > c ? a + r - e.collisionWidth : a : h > 0 ? t.left += h : c > 0 ? t.left -= c : t.left = s(t.left - l, t.left)
                },
                top: function(t, e) {
                    var n, o = e.within, a = o.isWindow ? o.scrollTop : o.offset.top, r = e.within.height, l = t.top - e.collisionPosition.marginTop, h = a - l, c = l + e.collisionHeight - r - a;
                    e.collisionHeight > r ? h > 0 && c <= 0 ? (n = t.top + h + e.collisionHeight - r - a,
                    t.top += h - n) : t.top = c > 0 && h <= 0 ? a : h > c ? a + r - e.collisionHeight : a : h > 0 ? t.top += h : c > 0 ? t.top -= c : t.top = s(t.top - l, t.top)
                }
            },
            flip: {
                left: function(t, e) {
                    var s, o, a = e.within, r = a.offset.left + a.scrollLeft, l = a.width, h = a.isWindow ? a.scrollLeft : a.offset.left, c = t.left - e.collisionPosition.marginLeft, u = c - h, d = c + e.collisionWidth - l - h, p = "left" === e.my[0] ? -e.elemWidth : "right" === e.my[0] ? e.elemWidth : 0, f = "left" === e.at[0] ? e.targetWidth : "right" === e.at[0] ? -e.targetWidth : 0, g = -2 * e.offset[0];
                ...
                top: function(t, e) {
                    var s, o, a = e.within, r = a.offset.top + a.scrollTop, l = a.height, h = a.isWindow ? a.scrollTop : a.offset.top, c = t.top - e.collisionPosition.marginTop, u = c - h, d = c + e.collisionHeight - l - h, p = "top" === e.my[1] ? -e.elemHeight : "bottom" === e.my[1] ? e.elemHeight : 0, f = "top" === e.at[1] ? e.targetHeight : "bottom" === e.at[1] ? -e.targetHeight : 0, g = -2 * e.offset[1];
    ...
    var a, r, l = "ui-effects-", h = "ui-effects-style", c = "ui-effects-animated", u = t;
    /*!
 ...
 */
    function(t, e) {
        ...
        function p(e) {
            ...
            u(o, function(t, s) {
                var o, a = s.re.exec(e), h = a && s.parse(a), c = s.space || "rgba";
                if (h)
                    return o = n[c](h),
                    n[r[c].cache] = o[r[c].cache],
                    l = n._rgba = o._rgba,
                    !1
            }),
            l.length ? ("0,0,0,0" === l.join() && t.extend(l, s.transparent),
            n) : s[e]
        }
        function f(t, e, s) {
        ...
        a.fn = t.extend(a.prototype, {
            parse: function(e, n, o, l) {
                ...
                var h = this
                  , c = t.type(e)
                  , f = this._rgba = [];
                return void 0 !== n && (e = [e, n, o, l],
                c = "array"),
                "string" === c ? this.parse(p(e) || s._default) : "array" === c ? (u(r.rgba.props, function(t, s) {
                    f[s.idx] = d(e[s.idx], s)
                }),
                ...
                : function(s, n) {
                    ...
                    h[o] && 0 > t.inArray(null, h[o].slice(0, 3)) && (h[o][3] = 1,
            ...
            transition: function(t, e) {
                var s = a(t)
                  ...
                  , p = c.slice();
                return s = s[o.cache],
                u(o.props, function(t, n) {
                    var o = n.idx
                      , a = c[o]
                      , r = s[o]
                      , h = l[n.type] || {};
                    null !== r && (null === a ? p[o] = r : (h.mod && (r - a > h.mod / 2 ? a += h.mod : a - r > h.mod / 2 && (a -= h.mod)),
                    p[o] = d((r - a) * e + a, n)))
                }),
                this[n](p)
            },
        ...
        r.hsla.to = function(t) {
            ...
            var e, s, n = t[0] / 255, o = t[1] / 255, a = t[2] / 255, r = t[3], l = Math.max(n, o, a), h = Math.min(n, o, a), c = l - h, u = l + h, d = .5 * u;
        ...
        u(r, function(e, s) {
            ...
            a.fn[e] = function(e) {
                ...
                void 0 === e)
                    return this[r].slice();
                var s, n = t.type(e), c = "array" === n || "object" === n ? e : arguments, p = this[r].slice();
            ...
            u(o, function(s, o) {
                a.fn[s] || (a.fn[s] = function(a) {
                    var r, l = t.type(a), h = "alpha" === s ? this._hsla ? "hsla" : "rgba" : e, c = this[h](), u = c[o.idx];
                    return "undefined" === l ? u : ("function" === l && (a = a.call(this, u),
                    l = t.type(a)),
                    null == a && o.empty ? this : ("string" === l && (r = n.exec(a)) && (a = u + parseFloat(r[2]) * ("+" === r[1] ? 1 : -1)),
                    c[o.idx] = a,
                    this[h](c)))
                }
                )
        ...
        a.hook = function(e) {
            u(e.split(" "), function(e, s) {
                ...
                t.fx.step[s] = function(e) {
                    e.colorInit || (e.start = a(e.elem, s),
                    e.end = a(e.end),
                    e.colorInit = !0),
        ...
        ,
        a.hook("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor"),
    ...
    function() {
        var e, s, n, o = ["add", "remove", "toggle"], a = {
            border: 1,
            borderBottom: 1,
            borderColor: 1,
            borderLeft: 1,
        ...
        function r(e) {
            var s, n, o = e.ownerDocument.defaultView ? e.ownerDocument.defaultView.getComputedStyle(e, null) : e.currentStyle, a = {};
            if (o && o.length && o[0] && o[o[0]])
                for (n = o.length; n--; )
                    "string" == typeof o[s = o[n]] && (a[t.camelCase(s)] = o[s]);
            else
                for (s in o)
                    "string" == typeof o[s] && (a[s] = o[s]);
            return a
        }
        t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function(e, s) {
            t.fx.step[s] = function(t) {
                ("none" === t.end || t.setAttr) && (1 !== t.pos || t.setAttr) || (u.style(t.elem, s, t.end),
                t.setAttr = !0)
            }
        }),
        ...
        t.effects.animateClass = function(e, s, n, l) {
            ...
            return this.queue(function() {
                var s, n = t(this), l = n.attr("class") || "", c = h.children ? n.find("*").addBack() : n;
                c = c.map(function() {
                    return {
                        el: t(this),
                        start: r(this)
                ...
                c = c.map(function() {
                    ...
                    this.diff = function e(s, n) {
                        ...
                        for (o in n)
                            r = n[o],
                            s[o] !== r && (a[o] || !t.fx.step[o] && isNaN(parseFloat(r)) || (l[o] = r));
                        return l
                    }(this.start, this.end),
                    this
                }),
        ...
        t.fn.extend({
            ...
            toggleClass: (n = t.fn.toggleClass,
            function(e, s, o, a, r) {
    ...
    function() {
        ...
        function a(e, s, n, o) {
            ...
            n = null,
            s = {}),
            ("number" == typeof s || t.fx.speeds[s]) && (o = n,
            n = s,
            s = {}),
            t.isFunction(n) && (o = n,
            n = null),
        ...
        !1 !== t.uiBackCompat && t.extend(t.effects, {
            save: function(t, e) {
                for (var s = 0, n = e.length; s < n; s++)
                    null !== e[s] && t.data(l + e[s], t[0].style[e[s]])
            },
            restore: function(t, e) {
                for (var s, n = 0, o = e.length; n < o; n++)
                    null !== e[n] && (s = t.data(l + e[n]),
                    t.css(e[n], s))
            },
            ...
            createWrapper: function(e) {
                ...
                t.each(["top", "left", "bottom", "right"], function(t, n) {
                    s[n] = e.css(n),
                    isNaN(parseInt(s[n], 10)) && (s[n] = "auto")
                }),
                e.css({
                    position: "relative",
                    top: 0,
            ...
            removeWrapper: function(e) {
                ...
                (e[0] === s || t.contains(e[0], s)) && t(s).trigger("focus")),
                e
            }
        }),
        t.extend(t.effects, {
            ...
            unshift: function(t, e, s) {
                var n = t.queue();
                e > 1 && n.splice.apply(n, [1, 0].concat(n.splice(e, s))),
                t.dequeue()
            },
            ...
            mode: function(t, e) {
                var s = t.is(":hidden");
                return "toggle" === e && (e = s ? "show" : "hide"),
                (s ? "hide" === e : "show" === e) && (e = "none"),
                e
            },
            ...
            createPlaceholder: function(e) {
                var s, n = e.css("position"), o = e.position();
                return e.css({
                ...
                s = t("<" + e[0].nodeName + ">").insertAfter(e).css({
        ...
        t.fn.extend({
            effect: function() {
                ...
                if (t.fx.off || !s)
                    return h ? this[h](e.duration, l) : this.each(function() {
                        l && l.call(this)
                    });
                function p(o) {
                    var a = t(this);
                    ...
                    e.mode = u.shift(),
                    !1 === t.uiBackCompat || n ? "none" === e.mode ? (a[h](),
                    r()) : s.call(a[0], e, function s() {
                        a.removeData(c),
                        t.effects.cleanUp(a),
                        "hide" === e.mode && a.hide(),
                        r()
        ...
        t.fx.step.clip = function(e) {
            ...
            "string" == typeof e.end && (e.end = u(e.end, e.elem)),
            e.clipInit = !0),
            t(e.elem).cssClip({
    ...
    t.effects.define("blind", "hide", function(e, s) {
        ...
        "show" === e.mode && (o.cssClip(l.clip),
        h && h.css(t.effects.clipToBox(l)),
        l.clip = r),
        h && h.animate(t.effects.clipToBox(l), e.duration, e.easing),
        o.animate(l, {
            queue: !1,
            duration: e.duration,
            easing: e.easing,
    ...
    t.effects.define("bounce", function(e, s) {
        var n, o, a, r = t(this), l = e.mode, h = "hide" === l, c = "show" === l, u = e.direction || "up", d = e.distance, p = e.times || 5, f = 2 * p + (c || h ? 1 : 0), g = e.duration / f, m = e.easing, v = "up" === u || "down" === u ? "top" : "left", b = "up" === u || "left" === u, y = 0, _ = r.queue().length;
        ...
        r.css("opacity", 0).css(v, b ? -(2 * d) : 2 * d).animate(o, g, m)),
        h && (d /= Math.pow(2, p - 1)),
        (o = {})[v] = a; y < p; y++)
            (n = {})[v] = (b ? "-=" : "+=") + d,
            r.animate(n, g, m).animate(o, g, m),
            d = h ? 2 * d : d / 2;
        h && ((n = {
            opacity: 0
        })[v] = (b ? "-=" : "+=") + d,
        r.animate(n, g, m)),
        r.queue(s),
        t.effects.unshift(r, _, f + 1)
    }),
    t.effects.define("clip", "hide", function(e, s) {
        var n, o = {}, a = t(this), r = e.direction || "vertical", l = "both" === r, h = l || "horizontal" === r, c = l || "vertical" === r;
        n = a.cssClip(),
        o.clip = {
    ...
    t.effects.define("drop", "hide", function(e, s) {
        var n, o = t(this), a = "show" === e.mode, r = e.direction || "left", l = "up" === r || "down" === r ? "top" : "left", h = "up" === r || "left" === r ? "-=" : "+=", c = {
            opacity: 0
        };
    ...
    t.effects.define("explode", "hide", function(e, s) {
        var n, o, a, r, l, h, c = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3, u = c, d = t(this), p = "show" === e.mode, f = d.show().css("visibility", "hidden").offset(), g = Math.ceil(d.outerWidth() / u), m = Math.ceil(d.outerHeight() / c), v = [];
        function b() {
            v.push(this),
            v.length === c * u && (d.css({
                visibility: "visible"
    ...
    t.effects.define("size", function(e, s) {
        ...
        "box" !== p && "both" !== p || (o.from.y !== o.to.y && (b = t.effects.setTransition(r, h, o.from.y, b),
        y = t.effects.setTransition(r, h, o.to.y, y)),
        o.from.x !== o.to.x && (b = t.effects.setTransition(r, c, o.from.x, b),
        y = t.effects.setTransition(r, c, o.to.x, y))),
        "content" !== p && "both" !== p || o.from.y !== o.to.y && (b = t.effects.setTransition(r, l, o.from.y, b),
        y = t.effects.setTransition(r, l, o.to.y, y)),
        f && (n = t.effects.getBaseline(f, v),
        ...
        r.css(b),
        "content" !== p && "both" !== p || (h = h.concat(["marginTop", "marginBottom"]).concat(l),
        ...
        r.find("*[width]").each(function() {
            ...
            o.from.y !== o.to.y && (a = t.effects.setTransition(s, h, o.from.y, a),
            r = t.effects.setTransition(s, h, o.to.y, r)),
            o.from.x !== o.to.x && (a = t.effects.setTransition(s, c, o.from.x, a),
            r = t.effects.setTransition(s, c, o.to.x, r)),
            d && t.effects.saveStyle(s),
            s.css(a),
        ...
        r.animate(y, {
            ...
            complete: function() {
                var e = r.offset();
                0 === y.opacity && r.css("opacity", b.opacity),
                d || (r.css("position", "static" === g ? "relative" : g).offset(e),
    ...
    t.effects.define("scale", function(e, s) {
        ...
        r.to.opacity = 0),
        t.effects.effect.size.call(this, r, s)
    }),
    ...
    t.effects.define("shake", function(e, s) {
        ...
        f[u] = (d ? "+=" : "-=") + 2 * r,
        g[u] = (d ? "-=" : "+=") + 2 * r,
        o.animate(p, c, e.easing); n < l; n++)
            o.animate(f, c, e.easing).animate(g, c, e.easing);
        o.animate(f, c, e.easing).animate(p, c / 2, e.easing).queue(s),
        t.effects.unshift(o, m, h + 1)
    }),
    t.effects.define("slide", "show", function(e, s) {
        var n, o, a = t(this), r = {
            ...
            left: ["right", "left"],
            right: ["left", "right"]
        }, l = e.mode, h = e.direction || "left", c = "up" === h || "down" === h ? "top" : "left", u = e.distance || a["top" === c ? "outerHeight" : "outerWidth"](!0), d = {};
        t.effects.createPlaceholder(a),
        n = a.cssClip(),
        o = a.position()[c],
        d[c] = ("up" === h || "left" === h ? -1 : 1) * u + o,
        d.clip = a.cssClip(),
        d.clip[r[h][1]] = d.clip[r[h][0]],
        "show" === l && (a.cssClip(d.clip),
        a.css(c, d[c]),
        d.clip = n,
        d[c] = o),
        a.animate(d, {
 ...
 */
    ...
    t.ui.focusable = function(e, s) {
        ...
        return "area" === h ? (o = (n = e.parentNode).name,
        !(!e.href || !o || "map" !== n.nodeName.toLowerCase()) && (a = t("img[usemap='#" + o + "']")).length > 0 && a.is(":visible")) : (/^(input|select|textarea|button|object)$/.test(h) ? (r = !e.disabled) && (l = t(e).closest("fieldset")[0]) && (r = !l.disabled) : r = "a" === h && e.href || s,
        r && t(e).is(":visible") && /*!
 ...
 */
        function t(e) {
            for (var s = e.css("visibility"); "inherit" === s; )
                s = (e = e.parent()).css("visibility");
            return "hidden" !== s
        }(t(e)))
    }
    ,
 ...
 */
    "1.7" === t.fn.jquery.substring(0, 3) && (t.each(["Width", "Height"], function(e, s) {
        ...
        function r(e, s, o, a) {
            return t.each(n, function() {
                s -= parseFloat(t.css(e, "padding" + this)) || 0,
                o && (s -= parseFloat(t.css(e, "border" + this + "Width")) || 0),
                a && (s -= parseFloat(t.css(e, "margin" + this)) || 0)
            }),
            s
        }
    ...
    t.fn.labels = function() {
        ...
        (n = this.attr("id")) && (a = (e = this.eq(0).parents().last()).add(e.length ? e.siblings() : this.siblings()),
        s = "label[for='" + t.ui.escapeSelector(n) + "']",
        o = o.add(a.find(s).addBack(s))),
        this.pushStack(o))
    }
    ,
    ...
    t.widget("ui.accordion", {
        ...
        _refresh: function() {
            var e, s = this.options, n = s.heightStyle, o = this.element.parent();
        ...
        _activate: function(e) {
            ...
            s !== this.active[0] && (s = s || this.active[0],
            this._eventHandler({
                target: s,
                currentTarget: s,
        ...
        _eventHandler: function(e) {
            var s, n, o = this.options, a = this.active, r = t(e.currentTarget), l = r[0] === a[0], h = l && o.collapsible, c = h ? t() : r.next(), u = a.next(), d = {
                oldHeader: a,
                oldPanel: u,
                newHeader: h ? t() : r,
                newPanel: c
            ...
            e.preventDefault(),
            l && !o.collapsible || !1 === this._trigger("beforeActivate", e, d) || (o.active = !h && this.headers.index(r),
            this.active = l ? t() : r,
            this._toggle(d),
            this._removeClass(a, "ui-accordion-header-active", "ui-state-active"),
            o.icons && (s = a.children(".ui-accordion-header-icon"),
            this._removeClass(s, null, o.icons.activeHeader)._addClass(s, null, o.icons.header)),
            l || (this._removeClass(r, "ui-accordion-header-collapsed")._addClass(r, "ui-accordion-header-active", "ui-state-active"),
            o.icons && (n = r.children(".ui-accordion-header-icon"),
        ...
        _toggle: function(e) {
            ...
            this.prevShow = s,
            this.prevHide = n,
            this.options.animate ? this._animate(s, n, e) : (n.hide(),
            s.show(),
            ...
            s.attr("aria-hidden", "false").prev().attr({
                "aria-selected": "true",
                "aria-expanded": "true",
                tabIndex: 0
            })
        ...
        _animate: function(t, e, s) {
            var n, o, a, r = this, l = 0, h = t.css("box-sizing"), c = t.length && (!e.length || t.index() < e.index()), u = this.options.animate || {}, d = c && u.down || u, p = function() {
                r._toggleComplete(s)
            };
            ...
            void t.hide().animate(this.showProps, {
                ...
                step: function(t, s) {
                    s.now = Math.round(t),
                    "height" !== s.prop ? "content-box" === h && (l += s.now) : "content" !== r.options.heightStyle && (s.now = Math.round(n - e.outerHeight() - l),
                    l = 0)
                }
    ...
    t.widget("ui.menu", {
        ...
        _create: function() {
            ...
            this._on({
                ...
                "click .ui-menu-item": function(e) {
                    ...
                    !this.mouseHandled && s.not(".ui-state-disabled").length && (this.select(e),
                    e.isPropagationStopped() || (this.mouseHandled = !0),
                    s.has(".ui-menu").length ? this.expand(e) : !this.element.is(":focus") && n.closest(".ui-menu").length && (this.element.trigger("focus", [!0]),
                ...
                "mouseenter .ui-menu-item": function(e) {
                    if (!this.previousFilter) {
                        var s = t(e.target).closest(".ui-menu-item")
                          , n = t(e.currentTarget);
                        s[0] === n[0] && (this._removeClass(n.siblings().children(".ui-state-active"), null, "ui-state-active"),
                        this.focus(e, n))
                    }
                },
        ...
        _keydown: function(e) {
            ...
            default:
                ...
                (s = a && -1 !== s.index(this.active.next()) ? this.active.nextAll(".ui-menu-item") : s).length || (o = String.fromCharCode(e.keyCode),
                s = this._filterMenuItems(o)),
        ...
        refresh: function() {
            var e, s, n, o, a, r = this, l = this.options.icons.submenu, h = this.element.find(this.options.menus);
            this._toggleClass("ui-menu-icons", null, !!this.element.find(".ui-icon").length),
            n = h.filter(":not(.ui-menu)").hide().attr({
                role: this.options.role,
                "aria-hidden": "true",
                "aria-expanded": "false"
            }).each(function() {
                ...
                r._addClass(n, "ui-menu-icon", "ui-icon " + l),
            ...
            (s = (e = h.add(this.element)).find(this.options.items)).not(".ui-menu-item").each(function() {
                var e = t(this);
            ...
            this._addClass(o, "ui-menu-item")._addClass(a, "ui-menu-item-wrapper"),
            s.filter(".ui-state-disabled").attr("aria-disabled", "true"),
        ...
        _scrollIntoView: function(e) {
            ...
            l = e.outerHeight(),
            o < 0 ? this.activeMenu.scrollTop(a + o) : o + l > r && this.activeMenu.scrollTop(a + o - r + l))
        },
        blur: function(t, e) {
        ...
        _open: function(e) {
            ...
            e.show().removeAttr("aria-hidden").attr("aria-expanded", "true").position(s)
        },
 ...
 */
    t.widget("ui.autocomplete", {
        ...
        pending: 0,
        _create: function() {
            var e, s, n, o = this.element[0].nodeName.toLowerCase(), a = "textarea" === o, r = "input" === o;
            ...
            this._on(this.menu.element, {
                ...
                menufocus: function(e, s) {
                    ...
                    (n = s.item.attr("aria-label") || o.value) && t.trim(n).length && (this.liveRegion.children().hide(),
        ...
        _searchTimeout: function(t) {
            ...
            this.searching = this._delay(function() {
                ...
                e && (!e || s || n) || (this.selectedItem = null,
                this.search(null, t))
            }, this.options.delay)
        },
        search: function(t, e) {
    ...
    t.widget("ui.autocomplete", t.ui.autocomplete, {
        ...
        __response: function(e) {
            ...
            this.options.disabled || this.cancelSearch || (s = e && e.length ? this.options.messages.results(e.length) : this.options.messages.noResults,
    ...
    function b() {
        ...
        this.dpDiv = y(t("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
    }
    function y(e) {
    ...
    t.widget("ui.controlgroup", {
        ...
        _initWidgets: function() {
            ...
            t.each(this.options.items, function(n, o) {
                var a, r = {};
                if (o)
                    return "controlgroupLabel" === n ? ((a = e.element.find(o)).each(function() {
                        var e = t(this);
                        e.children(".ui-controlgroup-label-contents").length || e.contents().wrapAll("<span class='ui-controlgroup-label-contents'></span>")
                    }),
                    e._addClass(a, null, "ui-widget ui-widget-content ui-state-default"),
                    void (s = s.concat(a.get()))) : void (t.fn[n] && (r = e["_" + n + "Options"] ? e["_" + n + "Options"]("middle") : {
                        classes: {}
                    },
                    e.element.find(o).each(function() {
                        ...
                        if ("button" !== n || !o.parent(".ui-spinner").length) {
                            a || (a = o[n]()[n]("instance")),
                            a && (l.classes = e._resolveClassesValues(l.classes, a)),
                            o[n](l);
                            var h = o[n]("widget");
                            t.data(h[0], "ui-controlgroup-data", a || o[n]("instance")),
                            s.push(h[0])
                        }
                    })))
            }),
        ...
        _resolveClassesValues: function(e, s) {
            ...
            return t.each(e, function(o) {
                ...
                a = t.trim(a.replace(v, "")),
                n[o] = (a + " " + e[o]).replace(/\s+/g, " ")
            }),
            n
        },
        _setOption: function(t, e) {
        ...
        refresh: function() {
            ...
            e.length && (t.each(["first", "last"], function(t, n) {
                ...
                if (o && s["_" + o.widgetName + "Options"]) {
                    ...
                    a.classes = s._resolveClassesValues(a.classes, o),
                    o.element[o.widgetName](a)
                } else
                    s._updateCornerClass(e[n](), n)
            }),
 ...
 */
    t.widget("ui.checkboxradio", [t.ui.formResetMixin, {
        ...
        _getRadioGroup: function() {
            var e, s = this.element[0].name, n = "input[name='" + t.ui.escapeSelector(s) + "']";
        ...
        _updateIcon: function(e) {
            ...
            "checkbox" === this.type ? (s += e ? "ui-icon-check ui-state-checked" : "ui-icon-blank",
            this._removeClass(this.icon, null, e ? "ui-icon-blank" : "ui-icon-check")) : s += "ui-icon-blank",
 ...
 */
    t.widget("ui.button", {
        ...
        _updateIcon: function(e, s) {
            ...
            this._attachIcon(o),
            "top" === o || "bottom" === o ? (this._addClass(this.icon, null, "ui-widget-icon-block"),
    ...
    t.fn.button = (g = t.fn.button,
    function() {
        return !this.length || this.length && "INPUT" !== this[0].tagName || this.length && "INPUT" === this[0].tagName && "checkbox" !== this.attr("type") && "radio" !== this.attr("type") ? g.apply(this, arguments) : (t.ui.checkboxradio || t.error("Checkboxradio widget missing"),
    ...
    t.extend(b.prototype, {
        ...
        _connectDatepicker: function(e, s) {
            ...
            s.append = t([]),
            s.trigger = t([]),
            n.hasClass(this.markerClassName) || (this._attachments(n, s),
        ...
        _attachments: function(e, s) {
            var n, o, a, r = this._get(s, "appendText"), l = this._get(s, "isRTL");
            s.append && s.append.remove(),
            r && (s.append = t("<span class='" + this._appendClass + "'>" + r + "</span>"),
            e[l ? "before" : "after"](s.append)),
            e.off("focus", this._showDatepicker),
            s.trigger && s.trigger.remove(),
            "focus" !== (n = this._get(s, "showOn")) && "both" !== n || e.on("focus", this._showDatepicker),
            "button" !== n && "both" !== n || (o = this._get(s, "buttonText"),
            a = this._get(s, "buttonImage"),
            s.trigger = t(this._get(s, "buttonImageOnly") ? t("<img/>").addClass(this._triggerClass).attr({
                src: a,
                alt: o,
                title: o
        ...
        _autoSize: function(t) {
            if (this._get(t, "autoSize") && !t.inline) {
                var e, s, n, o, a = new Date(2009,11,20), r = this._get(t, "dateFormat");
                r.match(/[DM]/) && (e = function(t) {
                    for (s = 0,
                    n = 0,
                    o = 0; o < t.length; o++)
                        t[o].length > s && (s = t[o].length,
                        n = o);
                    return n
                }
                ,
        ...
        _inlineDatepicker: function(e, s) {
            var n = t(e);
            n.hasClass(this.markerClassName) || (n.addClass(this.markerClassName).append(s.dpDiv),
            t.data(e, "datepicker", s),
        ...
        _dialogDatepicker: function(e, s, n, o, a) {
            ...
            w(d.settings, o || {}),
            s = s && s.constructor === Date ? this._formatDate(d, s) : s,
        ...
        _destroyDatepicker: function(e) {
            var s, n = t(e), o = t.data(e, "datepicker");
            n.hasClass(this.markerClassName) && (s = e.nodeName.toLowerCase(),
            t.removeData(e, "datepicker"),
            "input" === s ? (o.append.remove(),
            o.trigger.remove(),
            n.removeClass(this.markerClassName).off("focus", this._showDatepicker).off("keydown", this._doKeyDown).off("keypress", this._doKeyPress).off("keyup", this._doKeyUp)) : "div" !== s && "span" !== s || n.removeClass(this.markerClassName).empty(),
            m === o && (m = null))
        },
        _enableDatepicker: function(e) {
            var s, n, o = t(e), a = t.data(e, "datepicker");
            o.hasClass(this.markerClassName) && ("input" === (s = e.nodeName.toLowerCase()) ? (e.disabled = !1,
            a.trigger.filter("button").each(function() {
                this.disabled = !1
            }).end().filter("img").css({
                opacity: "1.0",
                cursor: ""
            })) : "div" !== s && "span" !== s || ((n = o.children("." + this._inlineClass)).children().removeClass("ui-state-disabled"),
        ...
        _disableDatepicker: function(e) {
            var s, n, o = t(e), a = t.data(e, "datepicker");
            o.hasClass(this.markerClassName) && ("input" === (s = e.nodeName.toLowerCase()) ? (e.disabled = !0,
            a.trigger.filter("button").each(function() {
                this.disabled = !0
            }).end().filter("img").css({
                opacity: "0.5",
                cursor: "default"
            })) : "div" !== s && "span" !== s || ((n = o.children("." + this._inlineClass)).children().addClass("ui-state-disabled"),
        ...
        _optionDatepicker: function(e, s, n) {
            ...
            if (2 === arguments.length && "string" == typeof s)
                return "defaults" === s ? t.extend({}, t.datepicker._defaults) : h ? "all" === s ? t.extend({}, h.settings) : this._get(h, s) : null;
            o = s || {},
        ...
        _getDateDatepicker: function(t, e) {
            var s = this._getInst(t);
            return s && !s.inline && this._setDateFromField(s, e),
            s ? this._getDate(s) : null
        },
        _doKeyDown: function(e) {
            var s, n, o, a = t.datepicker._getInst(e.target), r = !0, l = a.dpDiv.is(".ui-datepicker-rtl");
            if (a._keyEvent = !0,
            t.datepicker._datepickerShowing)
                ...
                case 9:
                    ...
                    break;
                case 13:
                    return (o = t("td." + t.datepicker._dayOverClass + ":not(." + t.datepicker._currentClass + ")", a.dpDiv))[0] && t.datepicker._selectDay(e.target, a.selectedMonth, a.selectedYear, o[0]),
                    (s = t.datepicker._get(a, "onSelect")) ? (n = t.datepicker._formatDate(a),
                    s.apply(a.input ? a.input[0] : null, [n, a])) : t.datepicker._hideDatepicker(),
                    !1;
                case 27:
                    t.datepicker._hideDatepicker();
                    break;
        ...
        _doKeyPress: function(e) {
            ...
            if (t.datepicker._get(o, "constrainInput"))
                return s = t.datepicker._possibleChars(t.datepicker._get(o, "dateFormat")),
                n = String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode),
                e.ctrlKey || e.metaKey || n < " " || !s || s.indexOf(n) > -1
        },
        _doKeyUp: function(e) {
            var s, n = t.datepicker._getInst(e.target);
            if (n.input.val() !== n.lastVal)
                try {
                    (s = t.datepicker.parseDate(t.datepicker._get(n, "dateFormat"), n.input ? n.input.val() : null, t.datepicker._getFormatConfig(n))) && (t.datepicker._setDateFromField(n),
        ...
        _showDatepicker: function(e) {
            ...
            !1 !== (o = (n = t.datepicker._get(s, "beforeShow")) ? n.apply(e, [e, s]) : {}) && (w(s.settings, o),
            s.lastVal = null,
            ...
            r = t.datepicker._checkOffset(s, r, a),
            s.dpDiv.css({
 ...
 */
            function t(e) {
                for (var s, n; e.length && e[0] !== document; ) {
                    if (("absolute" === (s = e.css("position")) || "relative" === s || "fixed" === s) && (n = parseInt(e.css("zIndex"), 10),
                    !isNaN(n) && 0 !== n))
                        return n;
                    e = e.parent()
                }
            ...
            t.effects && t.effects.effect[l] ? s.dpDiv.show(l, t.datepicker._get(s, "showOptions"), h) : s.dpDiv[l || "show"](l ? h : null),
        ...
        _updateDatepicker: function(e) {
            ...
            var s, n = this._getNumberOfMonths(e), o = n[1], a = e.dpDiv.find("." + this._dayOverClass + " a");
            a.length > 0 && _.apply(a.get(0)),
        ...
        _checkOffset: function(e, s, n) {
            ...
            return s.left -= this._get(e, "isRTL") ? o - r : 0,
            s.left -= n && s.left === e.input.offset().left ? t(document).scrollLeft() : 0,
            s.top -= n && s.top === e.input.offset().top + l ? t(document).scrollTop() : 0,
            s.left -= Math.min(s.left, s.left + o > h && h > o ? Math.abs(s.left + o - h) : 0),
            s.top -= Math.min(s.top, s.top + a > c && c > a ? Math.abs(a + l) : 0),
            s
        },
        _findPos: function(e) {
            for (var s, n = this._getInst(e), o = this._get(n, "isRTL"); e && ("hidden" === e.type || 1 !== e.nodeType || t.expr.filters.hidden(e)); )
                e = e[o ? "previousSibling" : "nextSibling"];
            return [(s = t(e).offset()).left, s.top]
        },
        _hideDatepicker: function(e) {
            var s, n, o, a, r = this._curInst;
            !r || e && r !== t.data(e, "datepicker") || this._datepickerShowing && (s = this._get(r, "showAnim"),
        ...
        _adjustDate: function(e, s, n) {
            var o = t(e)
              , a = this._getInst(o[0]);
            this._isDisabledDatepicker(o[0]) || (this._adjustInstDate(a, s + ("M" === n ? this._get(a, "showCurrentAtPos") : 0), n),
        ...
        _gotoToday: function(e) {
            ...
            o.drawYear = o.selectedYear = o.currentYear) : (s = new Date,
            o.selectedDay = s.getDate(),
            o.drawMonth = o.selectedMonth = s.getMonth(),
            o.drawYear = o.selectedYear = s.getFullYear()),
        ...
        _selectMonthYear: function(e, s, n) {
            var o = t(e)
              , a = this._getInst(o[0]);
            a["selected" + ("M" === n ? "Month" : "Year")] = a["draw" + ("M" === n ? "Month" : "Year")] = parseInt(s.options[s.selectedIndex].value, 10),
            this._notifyChange(a),
            this._adjustDate(o)
        },
        _selectDay: function(e, s, n, o) {
            var a, r = t(e);
            t(o).hasClass(this._unselectableClass) || this._isDisabledDatepicker(r[0]) || ((a = this._getInst(r[0])).selectedDay = a.currentDay = t("a", o).html(),
        ...
        _selectDate: function(e, s) {
            var n, o = t(e), a = this._getInst(o[0]);
        ...
        _updateAlternate: function(e) {
            ...
            a && (s = this._get(e, "altFormat") || this._get(e, "dateFormat"),
            n = this._getDate(e),
            o = this.formatDate(s, n, this._getFormatConfig(e)),
            t(a).val(o))
        },
        ...
        iso8601Week: function(t) {
            ...
            return s.setDate(s.getDate() + 4 - (s.getDay() || 7)),
            e = s.getTime(),
            s.setMonth(0),
            s.setDate(1),
            Math.floor(Math.round((e - s) / 864e5) / 7) + 1
        },
        parseDate: function(e, s, n) {
            ...
            if ("" === (s = "object" == typeof s ? s.toString() : s + ""))
                return null;
            var o, a, r, l, h = 0, c = (n ? n.shortYearCutoff : null) || this._defaults.shortYearCutoff, u = "string" != typeof c ? c : (new Date).getFullYear() % 100 + parseInt(c, 10), d = (n ? n.dayNamesShort : null) || this._defaults.dayNamesShort, p = (n ? n.dayNames : null) || this._defaults.dayNames, f = (n ? n.monthNamesShort : null) || this._defaults.monthNamesShort, g = (n ? n.monthNames : null) || this._defaults.monthNames, m = -1, v = -1, b = -1, y = -1, _ = !1, w = function(t) {
                ...
                if (t.each(r, function(t, e) {
                    var n = e[1];
                    if (s.substr(h, n.length).toLowerCase() === n.toLowerCase())
                        return a = e[0],
                        h += n.length,
                        !1
                }),
            ...
            for (o = 0; o < e.length; o++)
                if (_)
                    ...
                    case "@":
                        ...
                        break;
                    case "!":
                        m = (l = new Date((k("!") - this._ticksTo1970) / 1e4)).getFullYear(),
                        v = l.getMonth() + 1,
                        b = l.getDate();
                        break;
                    case "'":
        ...
        formatDate: function(t, e, s) {
            if (!e)
                return "";
            var n, o = (s ? s.dayNamesShort : null) || this._defaults.dayNamesShort, a = (s ? s.dayNames : null) || this._defaults.dayNames, r = (s ? s.monthNamesShort : null) || this._defaults.monthNamesShort, l = (s ? s.monthNames : null) || this._defaults.monthNames, h = function(e) {
        ...
        _determineDate: function(e, s, n) {
            var o = function(t) {
              ...
              , a = function(s) {
                ...
                for (var o = (s.toLowerCase().match(/^c/) ? t.datepicker._getDate(e) : null) || new Date, a = o.getFullYear(), r = o.getMonth(), l = o.getDate(), h = /([+\-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, c = h.exec(s); c; ) {
                    ...
                    case "M":
                        r += parseInt(c[1], 10),
                        l = Math.min(l, t.datepicker._getDaysInMonth(a, r));
                        break;
                    case "y":
                    case "Y":
                        a += parseInt(c[1], 10),
            ...
            return (r = r && "Invalid Date" === r.toString() ? n : r) && (r.setHours(0),
            r.setMinutes(0),
            r.setSeconds(0),
            r.setMilliseconds(0)),
        ...
        _generateHTML: function(t) {
            var e, s, n, o, a, r, l, h, c, u, d, p, f, g, m, v, b, y, _, w, k, C, D, T, S, P, I, H, M, z, O, A, E, W, N, L, F, R, j, B = new Date, Y = this._daylightSavingAdjust(new Date(B.getFullYear(),B.getMonth(),B.getDate())), q = this._get(t, "isRTL"), U = this._get(t, "showButtonPanel"), K = this._get(t, "hideIfNoPrevNext"), V = this._get(t, "navigationAsDateFormat"), X = this._getNumberOfMonths(t), G = this._get(t, "showCurrentAtPos"), Q = this._get(t, "stepMonths"), Z = 1 !== X[0] || 1 !== X[1], J = this._daylightSavingAdjust(t.currentDay ? new Date(t.currentYear,t.currentMonth,t.currentDay) : new Date(9999,9,9)), tt = this._getMinMaxDate(t, "min"), te = this._getMinMaxDate(t, "max"), ti = t.drawMonth - G, ts = t.drawYear;
            if (ti < 0 && (ti += 12,
            ts--),
            te)
                for (e = this._daylightSavingAdjust(new Date(te.getFullYear(),te.getMonth() - X[0] * X[1] + 1,te.getDate())),
                e = tt && e < tt ? tt : e; this._daylightSavingAdjust(new Date(ts,ti,1)) > e; )
                    --ti < 0 && (ti = 11,
                    ts--);
            for (t.drawMonth = ti,
            t.drawYear = ts,
            s = this._get(t, "prevText"),
            s = V ? this.formatDate(s, this._daylightSavingAdjust(new Date(ts,ti - Q,1)), this._getFormatConfig(t)) : s,
            n = this._canAdjustMonth(t, -1, ts, ti) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "e" : "w") + "'>" + s + "</span></a>" : K ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "e" : "w") + "'>" + s + "</span></a>",
            o = this._get(t, "nextText"),
            o = V ? this.formatDate(o, this._daylightSavingAdjust(new Date(ts,ti + Q,1)), this._getFormatConfig(t)) : o,
            a = this._canAdjustMonth(t, 1, ts, ti) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + o + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "w" : "e") + "'>" + o + "</span></a>" : K ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + o + "'><span class='ui-icon ui-icon-circle-triangle-" + (q ? "w" : "e") + "'>" + o + "</span></a>",
            r = this._get(t, "currentText"),
            l = this._get(t, "gotoCurrent") && t.currentDay ? J : Y,
            r = V ? this.formatDate(r, l, this._getFormatConfig(t)) : r,
            h = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>",
            c = U ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (q ? h : "") + (this._isInRange(t, l) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + r + "</button>" : "") + (q ? "" : h) + "</div>" : "",
            ...
            C = 0; C < X[0]; C++) {
                ...
                this.maxRows = 4,
                T = 0; T < X[1]; T++) {
                    if (S = this._daylightSavingAdjust(new Date(ts,ti,t.selectedDay)),
                    P = " ui-corner-all",
                    I = "",
                    Z) {
                        ...
                        X[1] > 1)
                            ...
                            case 0:
                                ...
                                P = " ui-corner-" + (q ? "right" : "left");
                                break;
                            case X[1] - 1:
                                I += " ui-datepicker-group-last",
                                P = " ui-corner-" + (q ? "left" : "right");
                                break;
                            default:
                    ...
                    for (I += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + P + "'>" + (/all|left/.test(P) && 0 === C ? q ? a : n : "") + (/all|right/.test(P) && 0 === C ? q ? n : a : "") + this._generateMonthYearHeader(t, ti, ts, tt, te, C > 0 || T > 0, g, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>",
                    H = d ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "",
                    k = 0; k < 7; k++)
                        H += "<th scope='col'" + ((k + u + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + p[M = (k + u) % 7] + "'>" + f[M] + "</span></th>";
                    for (I += H + "</tr></thead><tbody>",
                    z = this._getDaysInMonth(ts, ti),
                    ts === t.selectedYear && ti === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, z)),
                    A = Math.ceil(((O = (this._getFirstDayOfMonth(ts, ti) - u + 7) % 7) + z) / 7),
                    E = Z && this.maxRows > A ? this.maxRows : A,
                    this.maxRows = E,
                    W = this._daylightSavingAdjust(new Date(ts,ti,1 - O)),
                    N = 0; N < E; N++) {
                        for (I += "<tr>",
                        L = d ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(W) + "</td>" : "",
                        k = 0; k < 7; k++)
                            F = v ? v.apply(t.input ? t.input[0] : null, [W]) : [!0, ""],
                            j = (R = W.getMonth() !== ti) && !y || !F[0] || tt && W < tt || te && W > te,
                            L += "<td class='" + ((k + u + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (R ? " ui-datepicker-other-month" : "") + (W.getTime() === S.getTime() && ti === t.selectedMonth && t._keyEvent || _.getTime() === W.getTime() && _.getTime() === S.getTime() ? " " + this._dayOverClass : "") + (j ? " " + this._unselectableClass + " ui-state-disabled" : "") + (R && !b ? "" : " " + F[1] + (W.getTime() === J.getTime() ? " " + this._currentClass : "") + (W.getTime() === Y.getTime() ? " ui-datepicker-today" : "")) + "'" + ((!R || b) && F[2] ? " title='" + F[2].replace(/'/g, "&#39;") + "'" : "") + (j ? "" : " data-handler='selectDay' data-event='click' data-month='" + W.getMonth() + "' data-year='" + W.getFullYear() + "'") + ">" + (R && !b ? "&#xa0;" : j ? "<span class='ui-state-default'>" + W.getDate() + "</span>" : "<a class='ui-state-default" + (W.getTime() === Y.getTime() ? " ui-state-highlight" : "") + (W.getTime() === J.getTime() ? " ui-state-active" : "") + (R ? " ui-priority-secondary" : "") + "' href='#'>" + W.getDate() + "</a>") + "</td>",
                    ...
                    ++ti > 11 && (ti = 0,
                    ts++),
                    D += I += "</tbody></table>" + (Z ? "</div>" + (X[0] > 0 && T === X[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                }
                w += D
            }
            return w += c,
        ...
        _generateMonthYearHeader: function(t, e, s, n, o, a, r, l) {
            var h, c, u, d, p, f, g, m, v = this._get(t, "changeMonth"), b = this._get(t, "changeYear"), y = this._get(t, "showMonthAfterYear"), _ = "<div class='ui-datepicker-title'>", w = "";
            if (a || !v)
                w += "<span class='ui-datepicker-month'>" + r[e] + "</span>";
            else {
                for (h = n && n.getFullYear() === s,
                c = o && o.getFullYear() === s,
                w += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>",
                u = 0; u < 12; u++)
                    (!h || u >= n.getMonth()) && (!c || u <= o.getMonth()) && (w += "<option value='" + u + "'" + (u === e ? " selected='selected'" : "") + ">" + l[u] + "</option>");
                w += "</select>"
            }
            if (y || (_ += w + (!a && v && b ? "" : "&#xa0;")),
            !t.yearshtml) {
                if (t.yearshtml = "",
                a || !b)
                    _ += "<span class='ui-datepicker-year'>" + s + "</span>";
                else {
                    for (d = this._get(t, "yearRange").split(":"),
                    p = (new Date).getFullYear(),
                    m = Math.max(g = (f = function(t) {
                    ...
                    t.yearshtml += "<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>"; g <= m; g++)
        ...
        _isInRange: function(t, e) {
            var s, n, o = this._getMinMaxDate(t, "min"), a = this._getMinMaxDate(t, "max"), r = null, l = null, h = this._get(t, "yearRange");
            return h && (s = h.split(":"),
            ...
            s[0].match(/[+\-].*/) && (r += n),
            s[1].match(/[+\-].*/) && (l += n)),
            (!o || e.getTime() >= o.getTime()) && (!a || e.getTime() <= a.getTime()) && (!r || e.getFullYear() >= r) && (!l || e.getFullYear() <= l)
        },
    ...
    t.widget("ui.mouse", {
        ...
        _mouseInit: function() {
            ...
            this.element.on("mousedown." + this.widgetName, function(t) {
                ...
                if (!0 === t.data(s.target, e.widgetName + ".preventClickEvent"))
                    return t.removeData(s.target, e.widgetName + ".preventClickEvent"),
 ...
 */
    t.widget("ui.draggable", t.ui.mouse, {
        ...
        _setContainment: function() {
            var e, s, n, o = this.options, a = this.document[0];
            ...
            (n = (s = t(o.containment))[0]) && (e = /(scroll|auto)/.test(s.css("overflow")),
        ...
        _generatePosition: function(t, e) {
            var s, n, o, a, r = this.options, l = this._isRootNode(this.scrollParent[0]), h = t.pageX, c = t.pageY;
            ...
            s = [this.containment[0] + n.left, this.containment[1] + n.top, this.containment[2] + n.left, this.containment[3] + n.top]) : s = this.containment,
            t.pageX - this.offset.click.left < s[0] && (h = s[0] + this.offset.click.left),
            t.pageY - this.offset.click.top < s[1] && (c = s[1] + this.offset.click.top),
            t.pageX - this.offset.click.left > s[2] && (h = s[2] + this.offset.click.left),
            t.pageY - this.offset.click.top > s[3] && (c = s[3] + this.offset.click.top)),
            r.grid && (o = r.grid[1] ? this.originalPageY + Math.round((c - this.originalPageY) / r.grid[1]) * r.grid[1] : this.originalPageY,
            c = s ? o - this.offset.click.top >= s[1] || o - this.offset.click.top > s[3] ? o : o - this.offset.click.top >= s[1] ? o - r.grid[1] : o + r.grid[1] : o,
            a = r.grid[0] ? this.originalPageX + Math.round((h - this.originalPageX) / r.grid[0]) * r.grid[0] : this.originalPageX,
            h = s ? a - this.offset.click.left >= s[0] || a - this.offset.click.left > s[2] ? a : a - this.offset.click.left >= s[0] ? a - r.grid[0] : a + r.grid[0] : a),
    ...
    t.ui.plugin.add("draggable", "connectToSortable", {
        start: function(e, s, n) {
            ...
            t(n.options.connectToSortable).each(function() {
                ...
                s && !s.options.disabled && (n.sortables.push(s),
                s.refreshPositions(),
        ...
        drag: function(e, s, n) {
            t.each(n.sortables, function() {
                ...
                a._intersectsWith(a.containerCache) && (o = !0,
                t.each(n.sortables, function() {
                ...
                a.fromOutside = n),
                a.currentItem && (a._mouseDrag(e),
                s.position = a.position)) : a.isOver && (a.isOver = 0,
    ...
    t.ui.plugin.add("draggable", "cursor", {
        start: function(e, s, n) {
            var o = t("body")
              , a = n.options;
            o.css("cursor") && (a._cursor = o.css("cursor")),
    ...
    t.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(e, s, n) {
            var o = n.options
              ...
              , l = n.document[0];
            r !== l && "HTML" !== r.tagName ? (o.axis && "x" === o.axis || (n.overflowOffset.top + r.offsetHeight - e.pageY < o.scrollSensitivity ? r.scrollTop = a = r.scrollTop + o.scrollSpeed : e.pageY - n.overflowOffset.top < o.scrollSensitivity && (r.scrollTop = a = r.scrollTop - o.scrollSpeed)),
            ...
            o.axis && "y" === o.axis || (e.pageX - t(l).scrollLeft() < o.scrollSensitivity ? a = t(l).scrollLeft(t(l).scrollLeft() - o.scrollSpeed) : t(window).width() - (e.pageX - t(l).scrollLeft()) < o.scrollSensitivity && (a = t(l).scrollLeft(t(l).scrollLeft() + o.scrollSpeed)))),
    ...
    t.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(e, s, n) {
            var o, a, r, l, h, c, u, d, p, f, g = n.options, m = g.snapTolerance, v = s.offset.left, b = v + n.helperProportions.width, y = s.offset.top, _ = y + n.helperProportions.height;
            for (p = n.snapElements.length - 1; p >= 0; p--)
                c = (h = n.snapElements[p].left - n.margins.left) + n.snapElements[p].width,
                d = (u = n.snapElements[p].top - n.margins.top) + n.snapElements[p].height,
                b < h - m || v > c + m || _ < u - m || y > d + m || !t.contains(n.snapElements[p].item.ownerDocument, n.snapElements[p].item) ? (n.snapElements[p].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {
                    snapItem: n.snapElements[p].item
                })),
                n.snapElements[p].snapping = !1) : ("inner" !== g.snapMode && (o = Math.abs(u - _) <= m,
                a = Math.abs(d - y) <= m,
                r = Math.abs(h - b) <= m,
                l = Math.abs(c - v) <= m,
                o && (s.position.top = n._convertPositionTo("relative", {
                    top: u - n.helperProportions.height,
                    left: 0
                }).top),
                a && (s.position.top = n._convertPositionTo("relative", {
                    top: d,
                    left: 0
                }).top),
                r && (s.position.left = n._convertPositionTo("relative", {
                    top: 0,
                    left: h - n.helperProportions.width
                }).left),
                l && (s.position.left = n._convertPositionTo("relative", {
                    top: 0,
                    left: c
                }).left)),
                f = o || a || r || l,
                "outer" !== g.snapMode && (o = Math.abs(u - y) <= m,
                a = Math.abs(d - _) <= m,
                r = Math.abs(h - v) <= m,
                l = Math.abs(c - b) <= m,
                o && (s.position.top = n._convertPositionTo("relative", {
                ...
                !n.snapElements[p].snapping && (o || a || r || l || f) && n.options.snap.snap && n.options.snap.snap.call(n.element, e, t.extend(n._uiHash(), {
                    snapItem: n.snapElements[p].item
                })),
    ...
    t.ui.plugin.add("draggable", "stack", {
        start: function(e, s, n) {
            var o, a = n.options, r = t.makeArray(t(a.stack)).sort(function(e, s) {
 ...
 */
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _create: function() {
            ...
            this._setupHandles(),
            s.autoHide && t(this.element).on("mouseenter", function() {
                s.disabled || (n._removeClass("ui-resizable-autohide"),
                n._handles.show())
            }).on("mouseleave", function() {
                s.disabled || n.resizing || (n._addClass("ui-resizable-autohide"),
                n._handles.hide())
            }),
            this._mouseInit()
        },
        ...
        _setupHandles: function() {
            var e, s, n, o, a, r = this.options, l = this;
            ...
            this.handles.constructor === String)
                ...
                this.handles = {},
                s = 0; s < n.length; s++)
                    o = "ui-resizable-" + (e = t.trim(n[s])),
                    a = t("<div>"),
                    this._addClass(a, "ui-resizable-handle " + o),
                    a.css({
                        zIndex: r.zIndex
                    }),
            ...
            this._renderAxis = function(e) {
                var s, n, o, a;
                for (s in e = e || this.element,
                this.handles)
                    this.handles[s].constructor === String ? this.handles[s] = this.element.children(this.handles[s]).first().show() : (this.handles[s].jquery || this.handles[s].nodeType) && (this.handles[s] = t(this.handles[s]),
                    this._on(this.handles[s], {
                        mousedown: l._mouseDown
                    })),
                    this.elementIsWrapper && this.originalElement[0].nodeName.match(/^(textarea|input|select|button)$/i) && (n = t(this.handles[s], this.element),
            ...
            this._handles.on("mouseover", function() {
                l.resizing || (this.className && (a = this.className.match(/ui-resizable-(se|sw|ne|nw|n|e|s|w)/i)),
                l.axis = a && a[1] ? a[1] : "se")
            }),
        ...
        _mouseCapture: function(e) {
            ...
            for (s in this.handles)
                ((n = t(this.handles[s])[0]) === e.target || t.contains(n, e.target)) && (o = !0);
            return !this.options.disabled && o
        },
        _mouseStart: function(e) {
            var s, n, o, a = this.options, r = this.element;
        ...
        _mouseDrag: function(e) {
            var s, n, o = this.originalMousePosition, a = this.axis, r = e.pageX - o.left || 0, l = e.pageY - o.top || 0, h = this._change[a];
            return this._updatePrevProperties(),
            !!h && (s = h.apply(this, [e, r, l]),
        ...
        _mouseStop: function(e) {
            ...
            return this._helper && (o = (n = (s = this._proportionallyResizeElements).length && /textarea/i.test(s[0].nodeName)) && this._hasScroll(s[0], "left") ? 0 : this.sizeDiff.height,
        ...
        _getPaddingPlusBorderDimensions: function(t) {
            for (var e = 0, s = [], n = [t.css("borderTopWidth"), t.css("borderRightWidth"), t.css("borderBottomWidth"), t.css("borderLeftWidth")], o = [t.css("paddingTop"), t.css("paddingRight"), t.css("paddingBottom"), t.css("paddingLeft")]; e < 4; e++)
                s[e] = parseFloat(n[e]) || 0,
                s[e] += parseFloat(o[e]) || 0;
            return {
                height: s[0] + s[2],
                width: s[1] + s[3]
            }
        ...
        _proportionallyResize: function() {
            if (this._proportionallyResizeElements.length)
                for (var t, e = 0, s = this.helper || this.element; e < this._proportionallyResizeElements.length; e++)
        ...
        _propagate: function(e, s) {
            t.ui.plugin.call(this, e, [s, this.ui()]),
            "resize" !== e && this._trigger(e, s, this.ui())
        },
        plugins: {},
        ui: function() {
            return {
    ...
    t.ui.plugin.add("resizable", "containment", {
        start: function() {
            var e, s, n, o, a, r, l, h = t(this).resizable("instance"), c = h.options, u = h.element, d = c.containment, p = d instanceof t ? d.get(0) : /parent/.test(d) ? u.parent().get(0) : d;
            ...
            r = h._hasScroll(p, "left") ? p.scrollWidth : a,
            l = h._hasScroll(p) ? p.scrollHeight : o,
            h.parentData = {
                element: p,
                left: n.left,
                top: n.top,
        ...
        resize: function(e) {
            var s, n, o, a, r = t(this).resizable("instance"), l = r.options, h = r.containerOffset, c = r.position, u = r._aspectRatio || e.shiftKey, d = {
                top: 0,
                left: 0
            }, p = r.containerElement, f = !0;
            p[0] !== document && /static/.test(p.css("position")) && (d = h),
            c.left < (r._helper ? h.left : 0) && (r.size.width = r.size.width + (r._helper ? r.position.left - h.left : r.position.left - d.left),
            u && (r.size.height = r.size.width / r.aspectRatio,
            f = !1),
            r.position.left = l.helper ? h.left : 0),
            c.top < (r._helper ? h.top : 0) && (r.size.height = r.size.height + (r._helper ? r.position.top - h.top : r.position.top),
            ...
            o && a ? (r.offset.left = r.parentData.left + r.position.left,
            r.offset.top = r.parentData.top + r.position.top) : (r.offset.left = r.element.offset().left,
            r.offset.top = r.element.offset().top),
            s = Math.abs(r.sizeDiff.width + (r._helper ? r.offset.left - d.left : r.offset.left - h.left)),
            n = Math.abs(r.sizeDiff.height + (r._helper ? r.offset.top - d.top : r.offset.top - h.top)),
            ...
            u && (r.size.width = r.size.height * r.aspectRatio,
            f = !1)),
            f || (r.position.left = r.prevPosition.left,
    ...
    t.ui.plugin.add("resizable", "grid", {
        resize: function() {
            var e, s = t(this).resizable("instance"), n = s.options, o = s.size, a = s.originalSize, r = s.originalPosition, l = s.axis, h = "number" == typeof n.grid ? [n.grid, n.grid] : n.grid, c = h[0] || 1, u = h[1] || 1, d = Math.round((o.width - a.width) / c) * c, p = Math.round((o.height - a.height) / u) * u, f = a.width + d, g = a.height + p, m = n.maxWidth && n.maxWidth < f, v = n.maxHeight && n.maxHeight < g, b = n.minWidth && n.minWidth > f, y = n.minHeight && n.minHeight > g;
            n.grid = h,
            b && (f += c),
            y && (g += u),
            m && (f -= c),
            v && (g -= u),
            /^(se|s|e)$/.test(l) ? (s.size.width = f,
            s.size.height = g) : /^(ne)$/.test(l) ? (s.size.width = f,
            s.size.height = g,
            s.position.top = r.top - p) : /^(sw)$/.test(l) ? (s.size.width = f,
            s.size.height = g,
            s.position.left = r.left - d) : ((g - u <= 0 || f - c <= 0) && (e = s._getPaddingPlusBorderDimensions(this)),
            g - u > 0 ? (s.size.height = g,
            s.position.top = r.top - p) : (g = u - e.height,
            s.size.height = g,
            s.position.top = r.top + a.height - g),
            f - c > 0 ? (s.size.width = f,
            s.position.left = r.left - d) : (f = c - e.width,
            s.size.width = f,
            s.position.left = r.left + a.width - f))
        }
    }),
    t.ui.resizable,
    /*!
 ...
 */
    t.widget("ui.dialog", {
        ...
        _createButtons: function() {
            ...
            t.isEmptyObject(s) || t.isArray(s) && !s.length ? this._removeClass(this.uiDialog, "ui-dialog-buttons") : (t.each(s, function(s, n) {
                var o, a;
                n = t.isFunction(n) ? {
                    click: n,
                    text: s
                ...
                t("<button></button>", n).button(a).appendTo(e.uiButtonSet).on("click", function() {
        ...
        _makeResizable: function() {
            ...
            this.uiDialog.resizable({
                ...
                stop: function(n, o) {
                    ...
                    s.height = e.uiDialog.height(),
                    s.width = e.uiDialog.width(),
                    s.position = {
                        my: "left top",
        ...
        _setOptions: function(e) {
            ...
            t.each(e, function(t, e) {
                s._setOption(t, e),
                t in s.sizeRelatedOptions && (n = !0),
                t in s.resizableRelatedOptions && (o[t] = e)
            }),
            n && (this._size(),
            this._position()),
        ...
        _setOption: function(e, s) {
            ...
            "disabled" !== e && (this._super(e, s),
            "appendTo" === e && this.uiDialog.appendTo(this._appendTo()),
            "buttons" === e && this._createButtons(),
            "closeText" === e && this.uiDialogTitlebarClose.button({
                label: t("<a>").text("" + this.options.closeText).html()
            }),
            "draggable" === e && ((n = a.is(":data(ui-draggable)")) && !s && a.draggable("destroy"),
            !n && s && this._makeDraggable()),
            "position" === e && this._position(),
            "resizable" === e && ((o = a.is(":data(ui-resizable)")) && !s && a.resizable("destroy"),
            o && "string" == typeof s && a.resizable("option", "handles", s),
            o || !1 === s || this._makeResizable()),
 ...
 */
    t.widget("ui.droppable", {
        ...
        _create: function() {
            var e, s = this.options, n = s.accept;
            this.isover = !1,
            this.isout = !0,
        ...
        _drop: function(e, s) {
            ...
            return !(!n || (n.currentItem || n.element)[0] === this.element[0]) && (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function() {
                ...
                }), s.options.tolerance, e))
                    return o = !0,
                    !1
            }),
            !o && !!this.accept.call(this.element[0], n.currentItem || n.element) && (this._removeActiveClass(),
 ...
 */
    ...
    t.ui.ddmanager = {
        ...
        prepareOffsets: function(e, s) {
            var n, o, a = t.ui.ddmanager.droppables[e.options.scope] || [], r = s ? s.type : null, l = (e.currentItem || e.element).find(":data(ui-droppable)").addBack();
            droppablesLoop: for (n = 0; n < a.length; n++)
                if (!(a[n].options.disabled || e && !a[n].accept.call(a[n].element[0], e.currentItem || e.element))) {
                    ...
                    a[n].visible && ("mousedown" === r && a[n]._activate.call(a[n], s),
        ...
        drop: function(e, s) {
            ...
            return t.each((t.ui.ddmanager.droppables[e.options.scope] || []).slice(), function() {
                this.options && (!this.options.disabled && this.visible && C(e, this, this.options.tolerance, s) && (n = this._drop.call(this, s) || n),
        ...
        drag: function(e, s) {
            ...
            t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function() {
                if (!this.options.disabled && !this.greedyChild && this.visible) {
                    var n, o, a, r = C(e, this, this.options.tolerance, s), l = !r && this.isover ? "isout" : r && !this.isover ? "isover" : null;
    ...
    t.widget("ui.selectable", t.ui.mouse, {
        ...
        _mouseStart: function(e) {
            ...
            this.selectees.filter(".ui-selected").each(function() {
                ...
                n.startselected = !0,
                e.metaKey || e.ctrlKey || (s._removeClass(n.$element, "ui-selected"),
                n.selected = !1,
                s._addClass(n.$element, "ui-unselecting"),
                n.unselecting = !0,
        ...
        _mouseDrag: function(e) {
            ...
            !this.options.disabled) {
                var s, n = this, o = this.options, a = this.opos[0], r = this.opos[1], l = e.pageX, h = e.pageY;
                return a > l && (s = l,
                l = a,
                a = s),
                r > h && (s = h,
                ...
                this.selectees.each(function() {
                    var s = t.data(this, "selectable-item")
                      , c = !1
                      , u = {};
                    s && s.element !== n.element[0] && (u.left = s.left + n.elementPos.left,
                    u.right = s.right + n.elementPos.left,
                    u.top = s.top + n.elementPos.top,
                    u.bottom = s.bottom + n.elementPos.top,
                    "touch" === o.tolerance ? c = !(u.left > l || u.right < a || u.top > h || u.bottom < r) : "fit" === o.tolerance && (c = u.left > a && u.right < l && u.top > r && u.bottom < h),
                    c ? (s.selected && (n._removeClass(s.$element, "ui-selected"),
                    s.selected = !1),
                    s.unselecting && (n._removeClass(s.$element, "ui-unselecting"),
                    s.unselecting = !1),
                    s.selecting || (n._addClass(s.$element, "ui-selecting"),
                    s.selecting = !0,
                    n._trigger("selecting", e, {
                        selecting: s.element
                    }))) : (s.selecting && ((e.metaKey || e.ctrlKey) && s.startselected ? (n._removeClass(s.$element, "ui-selecting"),
                    s.selecting = !1,
                    n._addClass(s.$element, "ui-selected"),
                    s.selected = !0) : (n._removeClass(s.$element, "ui-selecting"),
                    s.selecting = !1,
                    s.startselected && (n._addClass(s.$element, "ui-unselecting"),
                    s.unselecting = !0),
                    n._trigger("unselecting", e, {
                        unselecting: s.element
                    }))),
                    s.selected && (e.metaKey || e.ctrlKey || s.startselected || (n._removeClass(s.$element, "ui-selected"),
                    s.selected = !1,
                    n._addClass(s.$element, "ui-unselecting"),
                    s.unselecting = !0,
                    n._trigger("unselecting", e, {
                        unselecting: s.element
                    })))))
        ...
        _mouseStop: function(e) {
            ...
            t(".ui-unselecting", this.element[0]).each(function() {
                var n = t.data(this, "selectable-item");
                s._removeClass(n.$element, "ui-unselecting"),
                n.unselecting = !1,
                n.startselected = !1,
            ...
            t(".ui-selecting", this.element[0]).each(function() {
                var n = t.data(this, "selectable-item");
                s._removeClass(n.$element, "ui-selecting")._addClass(n.$element, "ui-selected"),
                n.selecting = !1,
                n.selected = !0,
                n.startselected = !0,
    ...
    t.widget("ui.selectmenu", [t.ui.formResetMixin, {
        ...
        _drawButton: function() {
            var e, s = this, n = this._parseOption(this.element.find("option:selected"), this.element[0].selectedIndex);
        ...
        _drawMenu: function() {
            ...
            this.menuInstance = this.menu.menu({
                ...
                select: function(t, s) {
                    t.preventDefault(),
                    e._setSelection(),
                    e._select(s.item.data("ui-selectmenu-item"), t)
                },
                focus: function(t, s) {
        ...
        _renderButtonItem: function(e) {
            var s = t("<span>");
            return this._setText(s, e.label),
            this._addClass(s, "ui-selectmenu-text"),
            s
        },
        _renderMenu: function(e, s) {
            var n = this
        ...
        _renderItem: function(e, s) {
            ...
            return s.disabled && this._addClass(n, null, "ui-state-disabled"),
            this._setText(o, s.label),
            n.append(o).appendTo(e)
        },
        ...
        _move: function(t, e) {
            ...
            this.isOpen ? s = this.menuItems.eq(this.focusIndex).parent("li") : (s = this.menuItems.eq(this.element[0].selectedIndex).parent("li"),
    ...
    t.widget("ui.slider", t.ui.mouse, {
        ...
        _createHandles: function() {
            var e, s, n = this.options, o = this.element.find(".ui-slider-handle"), a = [];
            for (s = n.values && n.values.length || 1,
            o.length > s && (o.slice(s).remove(),
            o = o.slice(0, s)),
            e = o.length; e < s; e++)
        ...
        _mouseCapture: function(e) {
            var s, n, o, a, r, l, h, c, u = this, d = this.options;
            ...
            this.handles.each(function(e) {
                ...
                (o > s || o === s && (e === u._lastChangedValue || u.values(e) === d.min)) && (o = s,
                a = t(this),
                r = e)
            }),
            !1 !== (l = this._start(e, r)) && (this._mouseSliding = !0,
            this._handleIndex = r,
        ...
        _mouseDrag: function(t) {
            ...
            return this._slide(t, this._handleIndex, s),
            !1
        },
        ...
        _normValueFromMouse: function(t) {
            ...
            s = t.x - this.elementOffset.left - (this._clickOffset ? this._clickOffset.left : 0)) : (e = this.elementSize.height,
        ...
        _slide: function(t, e, s) {
            var n, o, a = this.value(), r = this.values();
            this._hasMultipleValues() && (o = this.values(e ? 0 : 1),
            a = this.values(e),
            2 === this.options.values.length && !0 === this.options.range && (s = 0 === e ? Math.min(o, s) : Math.max(o, s)),
            r[e] = s),
            s !== a && !1 !== (n = this._trigger("slide", t, this._uiHash(e, s, r))) && (this._hasMultipleValues() ? this.values(e, s) : this.value(s))
        },
        _stop: function(t, e) {
        ...
        values: function(e, s) {
            ...
            if (arguments.length > 1)
                return this.options.values[e] = this._trimAlignValue(s),
                this._refreshValue(),
            ...
            o = arguments[0],
            a = 0; a < n.length; a += 1)
                n[a] = this._trimAlignValue(o[a]),
                this._change(null, a);
            this._refreshValue()
        },
        _setOption: function(e, s) {
            var n, o = 0;
            switch ("range" === e && !0 === this.options.range && ("min" === s ? (this.options.value = this._values(0),
            this.options.values = null) : "max" === s && (this.options.value = this._values(this.options.values.length - 1),
        ...
        _trimAlignValue: function(t) {
            ...
            var e = this.options.step > 0 ? this.options.step : 1
              ...
              , n = t - s;
            return 2 * Math.abs(s) >= e && (n += s > 0 ? e : -e),
        ...
        _calculateNewMax: function() {
            var t = this.options.max
              , e = this._valueMin()
              , s = this.options.step;
            (t = Math.round((t - e) / s) * s + e) > this.options.max && (t -= s),
        ...
        _refreshValue: function() {
            var e, s, n, o, a, r = this.options.range, l = this.options, h = this, c = !this._animateOff && l.animate, u = {};
            this._hasMultipleValues() ? this.handles.each(function(n) {
                s = (h.values(n) - h._valueMin()) / (h._valueMax() - h._valueMin()) * 100,
                u["horizontal" === h.orientation ? "left" : "bottom"] = s + "%",
                t(this).stop(1, 1)[c ? "animate" : "css"](u, l.animate),
                !0 === h.options.range && ("horizontal" === h.orientation ? (0 === n && h.range.stop(1, 1)[c ? "animate" : "css"]({
                    left: s + "%"
                }, l.animate),
                1 === n && h.range[c ? "animate" : "css"]({
                    width: s - e + "%"
                }, {
                    queue: !1,
                    duration: l.animate
            ...
            u["horizontal" === this.orientation ? "left" : "bottom"] = s + "%",
            this.handle.stop(1, 1)[c ? "animate" : "css"](u, l.animate),
        ...
        _handleEvents: {
            keydown: function(e) {
                ...
                n = o = this._hasMultipleValues() ? this.values(r) : this.value(),
                e.keyCode) {
                case t.ui.keyCode.HOME:
                    o = this._valueMin();
                    break;
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _mouseCapture: function(e, s) {
            ...
            !!n && !(this.options.handle && !s && (t(this.options.handle, n).find("*").addBack().each(function() {
                this === e.target && (o = !0)
            }),
            !o)) && (this.currentItem = n,
        ...
        _mouseDrag: function(e) {
            var s, n, o, a, r = this.options, l = !1;
            for (this.position = this._generatePosition(e),
            this.positionAbs = this._convertPositionTo("absolute"),
            this.lastPositionAbs || (this.lastPositionAbs = this.positionAbs),
            this.options.scroll && (this.scrollParent[0] !== this.document[0] && "HTML" !== this.scrollParent[0].tagName ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - e.pageY < r.scrollSensitivity ? this.scrollParent[0].scrollTop = l = this.scrollParent[0].scrollTop + r.scrollSpeed : e.pageY - this.overflowOffset.top < r.scrollSensitivity && (this.scrollParent[0].scrollTop = l = this.scrollParent[0].scrollTop - r.scrollSpeed),
            this.overflowOffset.left + this.scrollParent[0].offsetWidth - e.pageX < r.scrollSensitivity ? this.scrollParent[0].scrollLeft = l = this.scrollParent[0].scrollLeft + r.scrollSpeed : e.pageX - this.overflowOffset.left < r.scrollSensitivity && (this.scrollParent[0].scrollLeft = l = this.scrollParent[0].scrollLeft - r.scrollSpeed)) : (e.pageY - this.document.scrollTop() < r.scrollSensitivity ? l = this.document.scrollTop(this.document.scrollTop() - r.scrollSpeed) : this.window.height() - (e.pageY - this.document.scrollTop()) < r.scrollSensitivity && (l = this.document.scrollTop(this.document.scrollTop() + r.scrollSpeed)),
            e.pageX - this.document.scrollLeft() < r.scrollSensitivity ? l = this.document.scrollLeft(this.document.scrollLeft() - r.scrollSpeed) : this.window.width() - (e.pageX - this.document.scrollLeft()) < r.scrollSensitivity && (l = this.document.scrollLeft(this.document.scrollLeft() + r.scrollSpeed))),
            !1 !== l && t.ui.ddmanager && !r.dropBehaviour && t.ui.ddmanager.prepareOffsets(this, e)),
            this.positionAbs = this._convertPositionTo("absolute"),
            this.options.axis && "y" === this.options.axis || (this.helper[0].style.left = this.position.left + "px"),
            this.options.axis && "x" === this.options.axis || (this.helper[0].style.top = this.position.top + "px"),
            s = this.items.length - 1; s >= 0; s--)
                if (o = (n = this.items[s]).item[0],
                (a = this._intersectsWithPointer(n)) && n.instance === this.currentContainer && !(o === this.currentItem[0] || this.placeholder[1 === a ? "next" : "prev"]()[0] === o || t.contains(this.placeholder[0], o) || "semi-dynamic" === this.options.type && t.contains(this.element[0], o))) {
        ...
        _intersectsWithPointer: function(t) {
            var e, s, n = "x" === this.options.axis || this._isOverAxis(this.positionAbs.top + this.offset.click.top, t.top, t.height), o = "y" === this.options.axis || this._isOverAxis(this.positionAbs.left + this.offset.click.left, t.left, t.width);
            return !(!n || !o) && (e = this._getDragVerticalDirection(),
            s = this._getDragHorizontalDirection(),
            this.floating ? "right" === s || "down" === e ? 2 : 1 : e && ("down" === e ? 2 : 1))
        },
        ...
        _refreshItems: function(e) {
            ...
            var s, n, o, a, r, l, h, c, u = this.items, d = [[t.isFunction(this.options.items) ? this.options.items.call(this.element[0], e, {
                item: this.currentItem
            ...
            if (p && this.ready)
                for (s = p.length - 1; s >= 0; s--)
                    for (n = (o = t(p[s], this.document[0])).length - 1; n >= 0; n--)
                        (a = t.data(o[n], this.widgetFullName)) && a !== this && !a.options.disabled && (d.push([t.isFunction(a.options.items) ? a.options.items.call(a.element[0], e, {
                            item: this.currentItem
            ...
            for (s = d.length - 1; s >= 0; s--)
                for (r = d[s][1],
                n = 0,
                c = (l = d[s][0]).length; n < c; n++)
                    (h = t(l[n])).data(this.widgetName + "-item", r),
                    u.push({
                        item: h,
                        instance: r,
                        width: 0,
        ...
        refreshPositions: function(e) {
            ...
            s = this.items.length - 1; s >= 0; s--)
                (n = this.items[s]).instance !== this.currentContainer && this.currentContainer && n.item[0] !== this.currentItem[0] || (o = this.options.toleranceElement ? t(this.options.toleranceElement, n.item) : n.item,
            ...
            n.placeholder = {
                element: function() {
                    var n = e.currentItem[0].nodeName.toLowerCase()
                      , o = t("<" + n + ">", e.document[0]);
                    return e._addClass(o, "ui-sortable-placeholder", s || e.currentItem[0].className)._removeClass(o, "ui-sortable-helper"),
                    "tbody" === n ? e._createTrPlaceholder(e.currentItem.find("tr").eq(0), t("<tr>", e.document[0]).appendTo(o)) : "tr" === n ? e._createTrPlaceholder(e.currentItem, o) : "img" === n && o.attr("src", e.currentItem.attr("src")),
                    s || o.css("visibility", "hidden"),
                    o
                },
                update: function(t, o) {
                    s && !n.forcePlaceholderSize || (o.height() || o.height(e.currentItem.innerHeight() - parseInt(e.currentItem.css("paddingTop") || 0, 10) - parseInt(e.currentItem.css("paddingBottom") || 0, 10)),
        ...
        _contactContainers: function(e) {
            var s, n, o, a, r, l, h, c, u, d, p = null, f = null;
            for (s = this.containers.length - 1; s >= 0; s--)
                if (!t.contains(this.currentItem[0], this.containers[s].element[0])) {
                    if (this._intersectsWith(this.containers[s].containerCache)) {
                        if (p && t.contains(this.containers[s].element[0], p.element[0]))
                            continue;
                        p = this.containers[s],
                        f = s
                    } else
                        this.containers[s].containerCache.over && (this.containers[s]._trigger("out", e, this._uiHash(this)),
            ...
            if (p) {
                if (1 === this.containers.length)
                    ...
                    for (o = 1e4,
                    a = null,
                    r = (u = p.floating || this._isFloating(this.currentItem)) ? "left" : "top",
                    l = u ? "width" : "height",
                    d = u ? "pageX" : "pageY",
                    n = this.items.length - 1; n >= 0; n--)
                        t.contains(this.containers[f].element[0], this.items[n].item[0]) && this.items[n].item[0] !== this.currentItem[0] && (h = this.items[n].item.offset()[r],
                        c = !1,
                        e[d] - h > this.items[n][l] / 2 && (c = !0),
                        Math.abs(e[d] - h) < o && (o = Math.abs(e[d] - h),
                        a = this.items[n],
        ...
        _createHelper: function(e) {
            ...
            return n.parents("body").length || t("parent" !== s.appendTo ? s.appendTo : this.currentItem[0].parentNode)[0].appendChild(n[0]),
        ...
        _generatePosition: function(e) {
            var s, n, o = this.options, a = e.pageX, r = e.pageY, l = "absolute" !== this.cssPosition || this.scrollParent[0] !== this.document[0] && t.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent, h = /(html|body)/i.test(l[0].tagName);
            ...
            o.grid && (s = this.originalPageY + Math.round((r - this.originalPageY) / o.grid[1]) * o.grid[1],
            r = this.containment ? s - this.offset.click.top >= this.containment[1] && s - this.offset.click.top <= this.containment[3] ? s : s - this.offset.click.top >= this.containment[1] ? s - o.grid[1] : s + o.grid[1] : s,
            n = this.originalPageX + Math.round((a - this.originalPageX) / o.grid[0]) * o.grid[0],
            a = this.containment ? n - this.offset.click.left >= this.containment[0] && n - this.offset.click.left <= this.containment[2] ? n : n - this.offset.click.left >= this.containment[0] ? n - o.grid[0] : n + o.grid[0] : n)),
            {
        ...
        _rearrange: function(t, e, s, n) {
            s ? s[0].appendChild(this.placeholder[0]) : e.item[0].parentNode.insertBefore(this.placeholder[0], "down" === this.direction ? e.item[0] : e.item[0].nextSibling),
        ...
        _clear: function(t, e) {
            ...
            s = this.containers.length - 1; s >= 0; s--)
                e || n.push(o("deactivate", this, this.containers[s])),
                this.containers[s].containerCache.over && (n.push(o("out", this, this.containers[s])),
                this.containers[s].containerCache.over = 0);
    ...
    t.widget("ui.spinner", {
        ...
        _keydown: function(e) {
            ...
            case n.DOWN:
                ...
                !0;
            case n.PAGE_UP:
                return this._repeat(null, s.page, e),
                !0;
            case n.PAGE_DOWN:
                return this._repeat(null, -s.page, e),
                !0
        ...
        _spin: function(t, e) {
            ...
            s = this._adjustValue(s + t * this._increment(this.counter)),
        ...
        _adjustValue: function(t) {
            ...
            return s = t - (e = null !== n.min ? n.min : 0),
            t = parseFloat((t = e + (s = Math.round(s / n.step) * n.step)).toFixed(this._precision())),
        ...
        _setOption: function(t, e) {
            ...
            if ("culture" === t || "numberFormat" === t)
                return s = this._parse(this.element.val()),
                this.options[t] = e,
                void this.element.val(this._format(s));
        ...
        _value: function(t, e) {
            var s;
            "" !== t && null !== (s = this._parse(t)) && (e || (s = this._adjustValue(s)),
            t = this._format(s)),
            this.element.val(t),
            this._refresh()
        },
 ...
 */
    t.widget("ui.tabs", {
        ...
        _create: function() {
            ...
            !1 !== this.options.active && this.anchors.length ? this.active = this._findActive(s.active) : this.active = t(),
            this._refresh(),
        ...
        _tabKeydown: function(e) {
            ...
            if (!this._handlePageNav(e)) {
                ...
                e.ctrlKey || e.metaKey || (s.attr("aria-selected", "false"),
        ...
        _findNextTab: function(e, s) {
            ...
            for (; -1 !== t.inArray(o(), this.options.disabled); )
                e = s ? e + 1 : e - 1;
            return e
        },
        ...
        _processTabs: function() {
            ...
            this.anchors.each(function(s, n) {
                ...
                e._isLocal(n) ? (r = (o = n.hash).substring(1),
                a = e.element.find(e._sanitizeSelector(o))) : (o = "#" + (r = h.attr("aria-controls") || t({}).uniqueId()[0].id),
                (a = e.element.find(o)).length || (a = e._createPanel(r)).insertAfter(e.panels[s - 1] || e.tablist),
        ...
        _setOptionDisabled: function(e) {
            ...
            o = 0; n = this.tabs[o]; o++)
                s = t(n),
                !0 === e || -1 !== t.inArray(o, e) ? (s.attr("aria-disabled", "true"),
                this._addClass(s, null, "ui-state-disabled")) : (s.removeAttr("aria-disabled"),
                this._removeClass(s, null, "ui-state-disabled"));
        ...
        _eventHandler: function(e) {
            ...
            e.preventDefault(),
            o.hasClass("ui-state-disabled") || o.hasClass("ui-tabs-loading") || this.running || a && !s.collapsible || !1 === this._trigger("beforeActivate", e, c) || (s.active = !r && this.tabs.index(o),
            this.active = a ? t() : o,
        ...
        _toggle: function(e, s) {
            ...
            function r() {
                n.running = !1,
                n._trigger("activate", e, s)
            }
            function l() {
                n._addClass(s.newTab.closest("li"), "ui-tabs-active", "ui-state-active"),
                o.length && n.options.show ? n._show(o, n.options.show, r) : (o.show(),
                r())
            }
            this.running = !0,
            a.length && this.options.hide ? this._hide(a, this.options.hide, function() {
                n._removeClass(s.oldTab.closest("li"), "ui-tabs-active", "ui-state-active"),
                l()
            }) : (this._removeClass(s.oldTab.closest("li"), "ui-tabs-active", "ui-state-active"),
            a.hide(),
            l()),
        ...
        enable: function(e) {
            ...
            !1 !== s && (void 0 === e ? s = !1 : (e = this._getIndex(e),
        ...
        load: function(e, s) {
            ...
            this._isLocal(a[0]) || (this.xhr = t.ajax(this._ajaxSettings(a, s, l)),
 ...
 */
    t.widget("ui.tooltip", {
        ...
        _addDescribedBy: function(e, s) {
            ...
            n.push(s),
            e.data("ui-tooltip-id", s).attr("aria-describedby", t.trim(n.join(" ")))
        },
        ...
        _disable: function() {
            ...
            t.each(this.tooltips, function(s, n) {
                var o = t.Event("blur");
                o.target = o.currentTarget = n.element[0],
                e.close(o, !0)
            }),
        ...
        _updateContent: function(t, e) {
            var s, n = this.options.content, o = this, a = e ? e.type : null;
            if ("string" == typeof n || n.nodeType || n.jquery)
                return this._open(e, t, n);
            (s = n.call(t[0], function(s) {
                o._delay(function() {
                    t.data("ui-tooltip-open") && (e && (e.type = a),
                    this._open(e, t, s))
                })
            })) && this._open(e, t, s)
        },
        _open: function(e, s, n) {
            ...
            n && ((o = this._find(s)) ? o.tooltip.find(".ui-tooltip-content").html(n) : (s.is("[title]") && (e && "mouseover" === e.type ? s.attr("title", "") : s.removeAttr("title")),
            a = (o = this._tooltip(s)).tooltip,
            this._addDescribedBy(s, a.attr("id")),
        ...
        close: function(e) {
            var s, n = this, o = t(e ? e.currentTarget : this.element), a = this._find(o);
            a ? (s = a.tooltip,
            ...
            e && "mouseleave" === e.type && t.each(this.parents, function(e, s) {
                t(s.element).attr("title", s.title),
                delete n.parents[e]
            }),
            a.closing = !0,
        ...
        _tooltip: function(e) {
            ...
            this._addClass(s, "ui-tooltip", "ui-widget ui-widget-content"),
            s.appendTo(this._appendTo(e)),
            this.tooltips[o] = {
                element: e,
                tooltip: s
            }
...
$(document).ready(function() {
    $(window).width(),
    $(".vertical-thumbnail-slider").slick({
        lazyLoad: "ondemand",
...
for (i = 0; i < addToCartBtn.length; i++)
    addToCartBtn[i].addEventListener("click", function() {
        ...
        console.log("productID: ", t, "action:", e),
        console.log("User:", user),
        "AnonymousUser" === user && addCookieItem("User not logged in"),
        updateUserOrder(t, e)
    });
...
function addCookieItem(t, e) {
    ...
    "add" == e && (null == cart[t] ? cart[t] = {
        quantity: 1
    } : cart[t].quantity += 1),
    "remove" == e && (cart[t].quantity -= 1,
    cart[t].quantity <= 0 && (console.log("Item should be deleted"),
    delete cart[t])),
    console.log("CART:"),
...
for (i = 0; i < addToWishList.length; i++)
    addToWishList[i].addEventListener("click", function() {
        var t = this.dataset.product
          , e = this.dataset.action;
        console.log("productID: ", t, "action:", e),
        console.log("User:", user),
        "AnonymousUser" === user ? addCookieItem("User not logged in") : updateUserWishList(t, e)
    });
...
for (i = 0; i < addToCompare.length; i++)
    addToCompare[i].addEventListener("click", function() {
        var t = this.dataset.product
          , e = this.dataset.action;
        console.log("productID: ", t, "action:", e),
        console.log("User:", user),
        "AnonymousUser" === user ? addCookieItem("User not logged in") : updateCompareProduct(t, e)
    });
...
function startConverting() {
    ...
    e.start(),
    e.onstart = function() {
        $(".voice-search-btn").addClass("search-enable"),
        $(".voice-search-container").show()
    }
    ;
    var s = "";
    e.onresult = function(e) {
        ...
        for (var n = "", o = e.resultIndex; o < e.results.length; o++) {
            ...
            a.replace("\n", "<br>"),
            e.results[o].isFinal ? s += a : n += a
        }
        t.value = s + n,
        $(".voice-search-text").html(s + n),
        window.location.href = "/search/" + a.replace(RegExp("\\+", "g"), "-")
    }
    ,
    e.onerror = function(t) {
        console.log("Speech recognition error detected: " + t.error),
        notification('<div class="text-center">Permission to use microphone is blocked.</div>')
    }
}
function scrollSpy() {
    for (var t, e = $.map($(".scrollspy"), function(t, e) {
        ...
        $("#" + e[s]).offset().top <= $(window).scrollTop() && (t = e[s]);
    $(".spy-clickable a[href='#" + t + "']").parent().addClass("spy-active"),
    $(".spy-clickable a").not("a[href='#" + t + "']").parent().removeClass("spy-active")
}
function responseMessage(t) {
    $(".success-box").fadeIn(200),
    $(".success-box").html("<span>" + t + "</span>")
}
function showDiv(t) {
    $(this).hide(),
    $(t).show()
...
$(document).ready(function(t) {
    ...
    $("#searchproduct-item").autocomplete({
        ...
        focus: function(t, e) {
            return $("#searchproduct-item").val(e.item.label),
            !1
        },
        minLength: 2,
        select: function(t, e) {
            return $("#searchproduct-item").val(e.item.label),
            location.href = e.item.value,
            !1
        },
        open: function() {
    ...
    $("#searchproduct").autocomplete({
        ...
        focus: function(t, e) {
            return $("#searchproduct").val(e.item.label),
            !1
        },
        minLength: 2,
        select: function(t, e) {
    ...
    $(".coupon-text,.vc").click(function() {
        $(this).siblings(".coupon-text").select(),
        document.execCommand("copy"),
        notification('<p class="text-center text-white mb-0">Coupon code copied</p>')
    }),
    ...
    function t(e, n) {
        ...
        setTimeout(function() {
            $(a).attr("placeholder", l),
            ++s < o.length && t(r, a)
        }, Math.floor(41 * Math.random() + 50))
    }("Search for products, brands & more", e),
    $(".product-video-list").each(function() {
        productply = new Plyr($(this),{
            controls: ["play-large", "progress", "pip", "airplay", "fullscreen"]
        }),
        window.productply = productply,
        productply.on("play", t=>{
            t.detail.plyr
        }
        ),
    ...
    $(window).scroll(function() {
        var t = $("#header");
        $(window).scrollTop() >= n ? (t.addClass("u-header--sticky-top"),
        $("#content").css("margin-top", o + "px")) : (t.removeClass("u-header--sticky-top"),
        $("#content").css("margin-top", "0"))
    }),
    (size_li = $(".addReadMore li").size()) <= 5 && $("#read-more-features").hide(),
    $(".addReadMore li:lt(" + (x = 5) + ")").show(),
    $("#read-more-features").click(function() {
        $(".addReadMore li:lt(" + (x = x + 5 <= size_li ? x + 5 : size_li) + ")").show(),
        $("#read-more-features").show(),
        x == size_li && ($("#read-more-features").hide(),
        $("#read-less-features").show())
    }),
    $("#read-less-features").click(function() {
        x = x + 5 <= size_li ? x + 5 : size_li,
        $(".addReadMore > li").slice(5).hide(),
        $("#read-less-features").show(),
        x == size_li && ($("#read-less-features").hide(),
        $("#read-more-features").show())
    }),
        ...
        $.ajax({
            ...
            success: function(t) {
                ...
                $.each(t.data, function(n, o) {
                    o.redirect_url ? e += '<a class="bubble' + s + '" href="' + o.redirect_url + '" target="_blank"><li  class="list-inline-item mr-3 u-header-topbar__nav-item"> <img src="' + t.cdn_url + o.flash_banner + '"></li></a>' : e += '<a class="bubble' + s + '" href="javascript:;" target="_blank"><li class="list-inline-item mr-3 u-header-topbar__nav-item"> <img src="' + t.cdn_url + o.flash_banner + '"></li></a>',
                    s++
                });
                var n = "";
                if (t.coupon_data.length >= 1)
                    $.each(t.coupon_data, function(e, s) {
                        n += '<div class="js-slide" style="cursor: pointer;"><div class="modal-left-banner"> <img src="' + t.cdn_url + s.coupon_image + '"></div></div>'
                    }),
                    $(".offers-slider").html(n),
                    $.HSCore.components.HSSlickCarousel.init(".offers-slider");
                else {
                    var o = $(".offers-slider").data("img");
                    n += '<div class="js-slide" style="cursor: pointer;"><div class="modal-left-banner"> <img src="' + o + '"></div></div>',
                    $(".offers-slider").html(n),
                    $.HSCore.components.HSSlickCarousel.init(".offers-slider")
                }
    ...
    $.HSCore.components.HSValidation.init("#user-rating-reviews", {
        submitHandler: function(t) {
            $.ajax({
                ...
                success: function(t) {
                    ...
                    $(".success-box").html(""),
                    $("#user-rating-reviews")[0].reset(),
                    $(".review-msg").html('<p class="text-success font-size-12 mb-0">Thank you for your review. It has been submitted to the webmaster for approval.</p>'),
                    setTimeout(function() {
                        $(".review-msg").html("")
                    }, 5e3))
                },
                error: function(t) {
                    $("#user-rating-reviews").find("button[type=submit]").html("Raise a request"),
                    console.log(t.responseJSON),
                    $(".review-msg").html('<p class="text-danger font-size-12 mb-0">Something went wrong!</p>'),
                    setTimeout(function() {
                        $(".review-msg").html("")
                    }, 5e3)
                }
...
$(document).ready(function() {
    ...
    $("#ConnectToStoreModal").on("show.bs.modal", function(t) {
        var e = $(t.relatedTarget).data("product")
          , s = $(this);
        null != e && (s.find(".modal-body .ConnectToPhoneModal").attr("data-product", e),
        s.find(".modal-body .btn-appointment").attr("href", "/appointment/" + e))
    }),
    $("#AreaPincodeModal ").on("show.bs.modal", function(t) {
        var e = $(t.relatedTarget).data("product")
          , s = $("#ConnectToStoreModal");
        s.find(".modal-body .ConnectToPhoneModal").attr("data-product", e),
        s.find(".btn-appointment").attr("href", "/appointment/" + e)
    }),
    ...
    $(".review-tab").on("click", function(t) {
        ...
        if ("" !== this.hash) {
            ...
            $('[data-toggle="pill"][href="' + e + '"]').trigger("click")
        }
    }),
    $(function(t) {
        t("#lazyLoadLink").on("click", function() {
            ...
            t.ajax({
                ...
                success: function(n) {
                    ...
                    n.has_next ? e.data("page", s + 1) : e.hide(),
                    n.posts_html && t(n.posts_html).insertBefore("#load_more_btn")
                },
    ...
    t && (document.getElementById("stars").innerHTML = function t(e) {
        let s = [];
        for (var n = e = Math.round(2 * e) / 2; n >= 1; n--)
            s.push('<i class="fa fa-star" aria-hidden="true" style="color: gold;"></i>&nbsp;');
        .5 == n && s.push('<i class="fa fa-star-half-o" aria-hidden="true" style="color: gold;"></i>&nbsp;');
        for (let o = 5 - e; o >= 1; o--)
            s.push('<i class="fa fa-star-o" aria-hidden="true" style="color: gold;"></i>&nbsp;');
        return s.join("")
    }(t)),
...
function(t) {
    function e(s, n, o) {
        ...
        u.length && u.on("click", function() {
            s.addClass("stop-vertical-truncate"),
            s.text(s.data("vertical-truncator-original"))
        });
        ...
        y = y.replace(/[,\.\s]*$/g, ""),
        s.text(y),
        r.length !== y.length && s.append(c),
        s.trigger("vertical-truncator"),
        s.css({
            height: "auto",
            overflow: "auto"
        }),
        o && o(),
        s.hasClass("vertically-truncated") || t(window).on("resize", function() {
            s.hasClass("stop-vertical-truncate") || e(s, n, o)
        }),
        s.addClass("vertically-truncated")
    }
    window.vertical_truncator = e,
    t.fn.vertical_truncator = function(s, n) {
        e(t($this), s, n)
    }
    ,
...
function notification(t) {
    $(".notification-msg .toast-body .toast-msg").html(t),
    $(".notification-msg").toast("show"),
    setTimeout(function() {
...
function imageZoom(t, e) {
    ...
    function h(t) {
        ...
        h = e.y - 50,
        l > s.width - 100 && (l = s.width - 100),
        l < 0 && (l = 0),
        h > s.height - 100 && (h = s.height - 100),
        h < 0 && (h = 0),
        n.style.left = l + "px",
        n.style.top = h + "px",
        o.style.backgroundPosition = "-" + l * a + "px -" + h * r + "px"
    }
    s = document.getElementById(t),
    o = document.getElementById(e),
    (n = document.createElement("DIV")).setAttribute("class", "img-zoom-lens"),
    s.parentElement.insertBefore(n, s),
    a = o.offsetWidth / 100,
    r = o.offsetHeight / 100,
    l = $(".image-slider-div").width() + 55,
    o.style.backgroundImage = "url('" + s.src + "')",
    o.style.backgroundSize = s.width * a + "px " + s.height * r + "px",
    o.style.left = l + "px",
    n.addEventListener("mousemove", h),
    s.addEventListener("mousemove", h),
    n.addEventListener("touchmove", h),
...
$(".explore-more-list li").hover(function() {
    ...
    $(this).attr("data-src"),
    $(".explore-more-list").children("li").each(function(t, e) {
        $(".video-container").removeClass("active"),
        $(".explore-more-list li").removeClass("active")
    }),
    $(s).addClass("active"),
    e.addClass("active"),
...
$("#searchBtn").click(function(t) {
    t.preventDefault(),
    keyword = $("#searchproduct").val().trim(),
    searchBar(keyword)
}),
...
$("#searchProduct1").click(function(t) {
    t.preventDefault(),
    keyword = $("#searchproduct-item").val().trim(),
    searchBar(keyword)
}),
...
$(document).on("ready", function() {
    ...
    $("#addbillingdiffrentAddress").change(function() {
...
function playPauseVideo(t, e) {
    var s, n, o, a;
    if (o = (s = t.find(".plyr")).find("iframe").get(0),
    n = s.data("video-start"),
    s.hasClass("plyr--youtube"))
        switch (e) {
        case "play":
        ...
        s.hasClass("plyr--html5") && null != (a = s.find("video").get(0)) && ("play" === e ? a.play() : a.pause());
    s.hasClass("plyr--html5") && (a = s.find("video").get(0),
    console.log(a),
    null != a && ("play" === e ? a.play() : a.pause()))
}
function resizePlayer(t, e) {
    if (t[0]) {
        var s, n, o = $(".main-slider"), a = o.width(), r = o.height(), e = e || 16 / 9;
        t.each(function() {
            var t = $(this);
            a / e < r ? (s = Math.ceil(r * e),
            t.width(s).height(r).css({
                left: (a - s) / 2,
                top: 0
            })) : (n = Math.ceil(a / e),
...
$("#subscribeButtonExample2").click(function(t) {
    var e = $("#pincode").val()
      , s = $.isNumeric(e);
    return "" == e ? ($("#response_msg").text("Enter 6 digit area pincode"),
    !1) : 0 == s ? ($("#response_msg").text("Enter 6 digit valid pincode"),
    !1) : void $.ajax({
...
$(document).ready(function() {
    $("#inlineCheckbox3").on("click", function(t) {
        $("#inlineCheckbox3").is(":checked") && ($(".gifting").text("Gifting Charges"),
        $(".gifting_charges").text("₹20")),
        $("#inlineCheckbox3").is(":unchecked") && ($(".gifting").text(""),
        $(".gifting_charges").text(""))
    })
});
...
if (jQuery("#gmap_canvas2").length) {
    ...
    function e(t, e, s) {
        ...
        1 == arePointsNear(o, a, 200) && (e = 26.9124,
        s = 75.7873,
        n = 10.3),
        1 == arePointsNear(o = {
            lat: 22.8910824,
        ...
        s = 78.2647455,
        n = 8.3),
        t.length && null != t[0].pincode_search && 1 == t[0].pincode_search && (e = t[0].latitude,
        s = t[0].longitude);
        ...
        }), c = new google.maps.InfoWindow, u = "";
...
$(document).ready(function() {
    $.HSCore.components.HSSlickCarousel.init(".appointment-calender"),
    $("#dateselected").val(),
    $(".appointment-calender").on("beforeChange", function(t, e, s, n) {
    ...
    $.HSCore.components.HSValidation.init("#user_browser_visit", {
        submitHandler: function(t) {
            $.ajax({
                ...
                data: $(t).serialize(),
                success: function(t) {
                    "SUCCESS" === t.status && (alert("successfully."),
                    Cookies.set("website_user_form", !1, {
                        expires: 10
                    }),
                    location.reload())
...
function showPosition(t) {
    var e, s = t.coords.latitude, n = t.coords.longitude;
...
$("#pincodefinddata").keydown(function(t) {
    13 == t.keyCode && (pincode = $("input[name=pincodefinddata]").val(),
    x11 = "",
    y11 = "",
    $.ajax({
        url: "/get-pincode-city",
...
if (null != getPincode && getPincodeToCity(getPincode),
$("#kohiapp-subscribeButton").click(function() {
    var t = $("#subscribeSrEmail").val();
    if (!validateEmail(t))
        return notification('<p class="text-white text-center m-0">Enter valid Email</p>'),
        !1;
    "" != t && $.ajax({
        type: "POST",
        url: "/newsletter",
        ...
        success: function(t) {
            "SUCCESS" == t.status && notification('<p class="text-white text-center m-0">Thank you for Subscribing</p>'),
            "FAILURE" == t.status && notification('<p class="text-white text-center m-0">You have already subscribed to our newsletters.</p>')
        },
        error: function(t) {}
    })
}),
$(document).ready(function(t) {
    function e(t, e="add", n=!1, o) {
        ...
        $.ajax({
            ...
            success: function(t) {
                ...
                let e = ""
                  , o = 0;
                "success" === t.status ? (o = t.count || 0,
                $(".compare-toast-msg").toast("hide"),
                e = "<label>COMPARE</label><span class='pd-compare-count'>" + o + "</span>") : "failure" === t.status && "1" === t.type ? (o = t.count,
                $(a).prop("checked", !1),
                $(".compare-toast-msg").toast("show"),
                $(".compare-toast-msg .toast-body .toast-msg").html(t.msg),
                toast = !0,
                e = "<label>COMPARE</label><span class='pd-compare-count'>" + o + "</span>") : "failure" === t.status && "2" === t.type && (o = t.count,
                $(a).prop("checked", !1),
                $(".compare-toast-msg").toast("show"),
                $(".compare-toast-msg .toast-body .toast-msg").html(t.msg),
                toast = !0,
                e = "<label>COMPARE</label><span class='pd-compare-count'>" + o + "</span>");
                let r = "<a class='product-compare-url-btn' href='/compare'><div class=''>" + e + "</div></a>";
                $("body").find(".product-compare-url-btn").remove(),
                $("body").append(r),
                0 == o && $("body").find(".product-compare-url-btn").remove(),
                !0 === toast && setTimeout(function() {
                    $(".compare-toast-msg").toast("hide")
                }, 7e3),
                n && location.reload()
            },
        ...
        $.ajax({
            ...
            success: function(t) {
                $(".compare-product").each(function() {
                    var e = $(this).attr("id")
                      , s = $(this).val();
                    for (i = 0; i < t.compare_product_id_list.length; i++)
                        t.compare_product_id_list[i] == s && $("#" + e).prop("checked", !0)
                })
            },
            error: function(t) {}
        })
    ...
    $(".compare-toast-msg .toast-body a").click(function() {
        $(".compare-product").prop("checked", !1),
        e(product_id = null, action = "clear", should_refresh_page = !1)
    }),
...
$(document).ready(function(t) {
    function e(t, e="add", n=!1, o) {
        ...
        1 == $(a).data("wishlist") && $(a).attr("data-wishlist", !1),
        toast = !1,
        $.ajax({
            headers: {
                "X-CSRFToken": "{{csrf_token}}"
            ...
            success: function(t) {
                "success" === t.status && s(),
                "error" === t.status && !1 === t.login && (notification("Please login for wishlisting a product"),
...
$("#UserDetailget").length) {
    ...
    $(document).mouseleave(function() {
        ...
        "false" != t && 0 == e && n < 100 && (o < 1 && s > 300 && $("#UserDetailget").modal("show"),
        o++)
    })
}
