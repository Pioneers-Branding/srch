<div class="sidebar-base
    ...
    <div class="d-flex align-items-center justify-content-start">
        <div class="logo-main d-none">
            <a href="{{route('backend.dashboard')}}" class="navbar-brand">
                <img class="logo-normal img-fluid" src="{{asset(setting('logo'))}}" height="30" alt="nutri health">
                <img class="logo-normal dark-normal img-fluid" src="{{asset(setting('dark_logo'))}}" height="30" alt="nutri health">
                <img class="logo-mini img-fluid" src="{{asset(setting('mini_logo'))}}" height="30" alt="nutri heath">
                <img class="logo-mini dark-mini img-fluid" src="{{asset(setting('dark_mini_logo'))}}" height="30" alt="nutri health">
            </a>
        </div>
