...
<div class="row">
    <a type="button" href="{{ route('backend.bookings.datatable_view') }}" class="btn btn-primary  create_btn" data-crud-id="0" title="Create services">
