...
<script>
    ...
    function validateForm() {
        ...
        if (isValid) {
            $('#onlineClick').prop('disabled', false); // Enable button
        } else {
            $('#onlineClick').prop('disabled', true); // Disable button
        }
    }
   ...
   $(document).ready(function() {
        ...
        function RazorpayCheckout(amount, currency, order_id, callback) {
            var options = {
                ...
                "image": "{{ asset('frontend/assets/srcamain/images/logo-black03.png') }}",
                "order_id": order_id,
