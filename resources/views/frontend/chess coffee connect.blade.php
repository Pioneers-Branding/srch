...
<div class="container">
   <div class="row events11">
      <div class="col-lg-12">
         <div class="coffee single-box">
            <p class="parag"> Welcome to <b>Chess Coffee Connect</b>— where we blend the strategic depth of chess with
      ...
      <div class="col-lg-6">
         <div class="proced-box neww-v z1 brd-rd5 thm-bg position-relative w-100">
            <span class="rounded-circle position-absolute">6</span>
            <h4 ><a href="#" title="">Etiquette & Sportsmanship</a></h4>
            <ul>
     ...
     <div class="row">
      <div class="col-lg-6">
         <div class="proced-box z1 brd-rd5 neww-v thm-bg position-relative w-100">
            <span class="rounded-circle position-absolute">8</span>
      ...
      <div class="col-lg-6">
         <div class="proced-box z1 neww-v brd-rd5 thm-bg position-relative w-100">
            <span class="rounded-circle position-absolute">7</span>
