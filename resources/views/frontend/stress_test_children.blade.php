                                ...
                                <div class="container">
                                    ...
                                    <div class="baa">
                                        ...
                                        <div style="text-align: center;" >
                                                <a href="{{ route('front.contact') }}" class="thm-btn thm-bg d-inline-block position-relative overflow-hidden" style="text-align: center; margin-top: 5%; color:#000;">Your mind matters,Let’s talk</a>
                                            </div>
